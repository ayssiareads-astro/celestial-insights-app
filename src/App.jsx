...
// ── Transit Interpretations Library ─────────────────────────────
// Keyed as "TransitingPlanet-NatalPlanet-aspecttype" (all lowercase)
const transitInterpLib = {
  // ── SUN TRANSITS ──────────────────────────────────────────────
  "sun-sun-conjunction": "The Sun is making its annual return to its natal position — this is your solar return energy building. It brings a surge of vitality and a renewed sense of who you are. The next few days carry a charge of personal reinvention.",
  "sun-sun-trine": "The Sun is in a flowing relationship with your natal Sun. You feel more like yourself than usual — confident, clear, and energized without having to push for it. Act on what feels right.",
  "sun-sun-sextile": "The Sun opens a window of clarity about who you are and what you want. Not a dramatic transit — but a genuinely useful one for making decisions and presenting yourself well.",
  "sun-sun-square": "The Sun is creating some internal friction between who you are and who you are becoming. You may feel pulled in different directions. Use this tension to clarify rather than force.",
  "sun-sun-opposition": "The Sun is illuminating a tension between your sense of self and how others are reflecting you back. What you are seeing in others right now has something important to say about yourself.",
  "sun-moon-conjunction": "The Sun is lighting up your emotional world directly. Feelings that have been quietly running in the background are now front and center. This is a good day to process, not suppress.",
  "sun-moon-trine": "Your identity and your emotional needs are in rare alignment today. You feel settled and real in a way that does not require external validation. Trust the inner signal.",
  "sun-moon-sextile": "A window opens between your conscious self and your emotional needs. Conversations about what you actually feel land more easily. Use it.",
  "sun-moon-square": "There is a tug of war between what you want to project and what you actually feel. The emotional reality is asking for attention even as the outer world demands performance.",
  "sun-moon-opposition": "Your drive to be seen and your need for emotional safety are pulling against each other. You may feel exposed in ways that are uncomfortable but clarifying.",
  "sun-mercury-conjunction": "Your mind is sharp and your ideas feel like extensions of your identity today. Good day for writing, speaking, pitching — your words carry authority.",
  "sun-mercury-trine": "Thinking and expressing yourself come naturally. Your ideas flow directly from your sense of self. Trust what you articulate today — it is unusually clear.",
  "sun-mercury-square": "Your mind and your ego are creating friction. You may overthink what others say or take communication personally. Pause before responding.",
  "sun-mercury-opposition": "Someone else's words or perspective is holding a mirror up to your own thinking. What annoys or interests you most in others' ideas right now reveals something about yourself.",
  "sun-venus-conjunction": "The Sun activates your Venus — a genuinely warm and magnetic day. You attract what you appreciate. Love, money, and beauty all receive a gentle boost.",
  "sun-venus-trine": "Charm and ease flow naturally. Your relationships feel nourishing and your aesthetic sense is heightened. A good day to connect, create, or receive.",
  "sun-venus-sextile": "A small but real opening for warmth and connection. Say the kind thing. Make the beautiful thing. Small gestures carry unusual weight today.",
  "sun-venus-square": "Your desire for harmony is in tension with your will. You may avoid a necessary truth to keep the peace, or push too hard where softness was called for.",
  "sun-venus-opposition": "Your sense of self and your relationship needs are asking for different things. A partner or close connection may be reflecting back something you need to look at.",
  "sun-mars-conjunction": "The Sun activates your natal Mars — this is one of the most energized transits in the annual cycle. Drive, ambition, and physical vitality all spike. Channel it rather than scatter it.",
  "sun-mars-trine": "Your willpower and identity are aligned. You move through obstacles with unusual ease today. Start what you have been putting off.",
  "sun-mars-sextile": "A window of useful energy opens. Not explosive, but practical and directed. Good for tackling what requires sustained effort.",
  "sun-mars-square": "Tension between your ego and your drive. You may feel frustrated, competitive, or like others are blocking you. The obstacle is information — not the enemy.",
  "sun-mars-opposition": "Your will is meeting its counterforce. The energy of opposition can be used for competition, negotiation, or finally confronting what you have been avoiding.",
  "sun-jupiter-conjunction": "The Sun activates your natal Jupiter — a genuinely expansive day. Opportunities feel more available, optimism comes naturally, and your presence is larger than usual.",
  "sun-jupiter-trine": "Growth and identity are working together beautifully. You feel genuinely lucky — not because circumstances have changed, but because your orientation to them has.",
  "sun-jupiter-square": "Your ambition may overreach today. You are seeing possibility, which is real — but the execution requires more patience than this transit suggests.",
  "sun-jupiter-opposition": "Someone or something external is offering expansion — but it may require you to adjust your sense of self to receive it. Growth often looks like loss at first.",
  "sun-saturn-conjunction": "The Sun activates your natal Saturn — a serious, grounding transit. You are being asked to take stock of where structure is missing. Not glamorous, but genuinely important.",
  "sun-saturn-trine": "Your ambitions and your discipline are aligned. Whatever you build today has solidity to it. A good day for long-term decisions.",
  "sun-saturn-square": "External demands or internal criticism are making your sense of self feel heavier than usual. The pressure is real — but it is also building something.",
  "sun-saturn-opposition": "Authority, responsibility, or reality is pushing back against your identity. What feels like a ceiling may be a redirect. Pay attention to what is actually being asked of you.",
  "sun-uranus-conjunction": "The Sun activates your natal Uranus — a jolt of originality and disruption. Something about who you are wants to break free from its current container. Let it be weird.",
  "sun-uranus-trine": "Your individuality and your need for freedom feel supported today. Original ideas arrive easily. Do not edit them before you try them.",
  "sun-uranus-square": "Tension between who you are and who you need to become. The restlessness you feel is not random — it is pointing somewhere worth going.",
  "sun-uranus-opposition": "Disruption is coming from outside. Someone or something is challenging your fixed sense of self. The breakthrough lives on the other side of the resistance.",
  "sun-neptune-conjunction": "The Sun meets natal Neptune — boundaries between self and everything else become genuinely porous. Your imagination is heightened but your judgment may be softer than usual. Trust your intuition, not your wishful thinking.",
  "sun-neptune-trine": "Creativity, spirituality, and compassion are flowing from a genuinely inspired place today. Make something. Offer something. Connect to what matters beyond the practical.",
  "sun-neptune-square": "Confusion between what is real and what you want to be real. Your identity may feel vague or under pressure. Clarity will return — give it space.",
  "sun-neptune-opposition": "Something idealized — a person, a vision, a version of yourself — is being gently dissolved. What remains after the fog lifts is more true.",
  "sun-pluto-conjunction": "The Sun activates natal Pluto — a transit of significant psychological depth. Power dynamics come to the surface. You are being asked to look at what you are controlling and what is controlling you.",
  "sun-pluto-trine": "Transformation and identity are working together. You have unusual access today to the deeper patterns driving your life — and real power to work with them.",
  "sun-pluto-square": "Power, control, and ego are in direct confrontation. Something wants to die so something truer can live. Do not force it — and do not resist it either.",
  "sun-pluto-opposition": "External forces are triggering your deepest psychological material. What feels like a power struggle is actually an invitation to transform.",
  "sun-chiron-conjunction": "The Sun activates your Chiron wound directly. Something tender surfaces — not to punish you, but because it is ready to be healed at a new level.",
  "sun-chiron-trine": "Your identity and your wound are in genuine conversation today. You can access the gift that lives inside the place that used to just hurt.",
  "sun-chiron-square": "The gap between who you feel you are and your oldest wound is creating pressure. The discomfort is not the wound reopening — it is the scar tissue loosening.",
  "sun-chiron-opposition": "Something outside you is touching your deepest wound. Use what comes up today for understanding, not for defending.",

  // ── MOON TRANSITS ─────────────────────────────────────────────
  "moon-sun-conjunction": "The Moon is crossing your natal Sun — an emotionally charged moment of alignment between your feelings and your identity. What you feel today is unusually close to the truth of who you are.",
  "moon-sun-trine": "Your emotional world and your sense of self are in harmony. A gentle, nourishing transit that makes you feel quietly at home in yourself.",
  "moon-sun-sextile": "A small emotional opening toward greater self-understanding. Good for any conversation about who you are and what you actually need.",
  "moon-sun-square": "A passing emotional friction between your feelings and your ego. You may feel reactive or out of sorts — it passes within hours. Let it move through.",
  "moon-sun-opposition": "Your emotional needs are pulling against your drive to be seen. The feeling that something is off is pointing to something worth looking at.",
  "moon-moon-conjunction": "The transiting Moon returns to its natal position — your monthly lunar return. Your emotional body is doing a reset. Intuition is sharper than usual right now.",
  "moon-moon-trine": "Your emotional world feels naturally in flow today. Relationships, home, and inner life all carry an ease that is worth settling into.",
  "moon-moon-sextile": "A brief window of emotional clarity and ease. Conversations about feelings land more gently than usual.",
  "moon-moon-square": "Passing emotional turbulence. You may feel more sensitive or reactive than makes sense for the situation. Give it space.",
  "moon-moon-opposition": "Your emotional needs are in tension with external demands. What you feel and what is required of you are pointing in different directions — for now.",
  "moon-mercury-conjunction": "The Moon activates your natal Mercury — your feelings and your mind are talking to each other in real time. Insights about your own patterns are available if you stay quiet enough to hear them.",
  "moon-mercury-trine": "Emotional intelligence is running high. You can articulate what you feel with unusual precision — and others can actually hear it.",
  "moon-mercury-square": "Your heart and your head are not agreeing. Avoid making major decisions or sending important messages until this passes.",
  "moon-mercury-opposition": "What you feel and what you think are pointing in opposite directions. The emotional signal is the more reliable one right now.",
  "moon-venus-conjunction": "The Moon activates natal Venus — one of the most genuinely pleasant transits in the lunar cycle. Warmth, connection, and beauty are available. Let yourself receive.",
  "moon-venus-trine": "Your emotional world and your capacity for love are perfectly aligned. A good day for relationships, creativity, and simple pleasure.",
  "moon-venus-sextile": "A window of warmth opens. Small acts of affection and beauty carry unusual resonance today.",
  "moon-venus-square": "A brief friction between what you feel and what you want in love. Your emotional needs and your relational desires are temporarily out of sync.",
  "moon-venus-opposition": "Your emotional world and your relationships are pulling in different directions. What you need and what your partnerships are offering may not match today.",
  "moon-mars-conjunction": "The Moon activates natal Mars — feelings can intensify quickly into action or reaction. Your drive is emotionally charged right now. Use it; do not let it use you.",
  "moon-mars-trine": "Your feelings and your drive are aligned. Emotional courage comes easily. A good transit for starting things that require both heart and nerve.",
  "moon-mars-square": "Emotional reactivity peaks. Your feelings are activating your anger or impatience — the provocation is real, but the response wants calibration.",
  "moon-mars-opposition": "Your emotional needs are in direct tension with your drive and assertiveness. Anger or frustration may surface unexpectedly. It is pointing to something legitimate.",
  "moon-jupiter-conjunction": "The Moon activates natal Jupiter — emotional generosity, warmth, and a sense of expansiveness arrive together. Your capacity to give and receive feels genuinely larger right now.",
  "moon-jupiter-trine": "Your feelings are naturally expansive and optimistic. Faith comes easily. A good day for anything that requires emotional openness.",
  "moon-jupiter-square": "Emotional excess may be the issue — feeling everything too strongly, reacting too big. The bigness of your feelings is real; the object may not match.",
  "moon-jupiter-opposition": "External abundance or generosity is meeting your emotional world in a slightly sideways way. Something that looks like good news requires emotional recalibration.",
  "moon-saturn-conjunction": "The Moon activates natal Saturn — emotional weight, responsibility, and a certain seriousness settle in. Old limitations resurface. Be honest with yourself about what is actually yours to carry.",
  "moon-saturn-trine": "Your emotional discipline is serving you well. You can feel things and still function — that is the gift of this transit.",
  "moon-saturn-square": "Emotional restriction or heaviness passes through. You may feel older than your years for a few hours. Let the feeling inform rather than define.",
  "moon-saturn-opposition": "Your emotional needs are bumping up against external structures or responsibilities. The limitation is real — but so is your capacity to work within it.",
  "moon-uranus-conjunction": "The Moon activates natal Uranus — an emotionally electric and unpredictable moment. Feelings arrive suddenly and from unexpected directions. Stay open.",
  "moon-uranus-trine": "Emotional freedom and originality flow easily. You may feel surprisingly detached from things that usually hook you — that is the gift.",
  "moon-uranus-square": "Emotional instability or restlessness passes through. Your need for freedom and your need for security are briefly at odds.",
  "moon-uranus-opposition": "External disruption is triggering your need for emotional independence. Something is changing whether you planned it or not.",
  "moon-neptune-conjunction": "The Moon activates natal Neptune — one of the most sensitizing transits in the lunar cycle. Your boundaries are at their most permeable. Beautiful and requiring discernment.",
  "moon-neptune-trine": "Emotional intuition and spiritual sensitivity are heightened. Trust the impressions that come today — they are cleaner than usual.",
  "moon-neptune-square": "Emotional confusion or hypersensitivity passes through. You may be picking up signals from others as if they were your own. Ground yourself.",
  "moon-neptune-opposition": "Your emotional world and your ideals are briefly at odds. The dream and the reality are showing their difference — let the honest version win.",
  "moon-pluto-conjunction": "The Moon activates natal Pluto — emotional intensity at its peak. Something beneath the surface comes up. This is not destruction; it is excavation.",
  "moon-pluto-trine": "Your emotional depth is an asset right now. You can access the truest layers of your feeling without being overwhelmed by them.",
  "moon-pluto-square": "Emotional power struggles or obsessive feeling patterns surface briefly. Something deep wants acknowledgment — not indulgence, but honest recognition.",
  "moon-pluto-opposition": "External intensity triggers your deepest emotional patterns. What you feel most strongly right now is connected to something older than today.",
  "moon-chiron-conjunction": "The Moon activates your Chiron wound — old tenderness surfaces. This is not punishment; it is the emotional body asking for compassion, not strength.",
  "moon-chiron-trine": "Your emotional world can touch the wounded place gently today, with understanding rather than pain.",
  "moon-chiron-square": "Brief emotional sensitivity around an old wound. The soreness is real — but it is also marking a place that is healing.",
  "moon-chiron-opposition": "Something external brushes against your oldest wound. Let the feeling be information rather than proof of anything.",

  // ── MERCURY TRANSITS ──────────────────────────────────────────
  "mercury-sun-conjunction": "Mercury activates your natal Sun — a sharp, clear moment for self-expression. What you say about yourself and your work lands with unusual authority today.",
  "mercury-sun-trine": "Mind and identity are flowing together. Ideas feel like genuine extensions of who you are. Write, speak, pitch — the timing is good.",
  "mercury-sun-square": "Your thinking and your ego are creating friction. You may be second-guessing yourself or taking feedback more personally than it deserves.",
  "mercury-sun-opposition": "Someone else's perspective is challenging your self-narrative. What you resist most in their words may be the most useful thing to hear.",
  "mercury-moon-conjunction": "Mercury activates your natal Moon — a moment of rare clarity about your emotional world. What you feel becomes something you can actually name and communicate.",
  "mercury-moon-trine": "Your mind and your emotions are cooperating beautifully. Emotional intelligence is running high. Good for any conversation that requires both honesty and care.",
  "mercury-moon-square": "Thoughts and feelings are pulling in different directions. Resist the urge to analyze your way out of what you need to simply feel.",
  "mercury-moon-opposition": "What you think and what you feel are presenting two different stories. The emotional signal deserves equal weight with the logical one.",
  "mercury-mercury-conjunction": "Mercury returns to its natal position — your annual Mercury return. Your mind is sharp and ideas feel like genuine extensions of who you are. A good day to communicate anything important.",
  "mercury-mercury-trine": "Your mind is operating with unusual fluency. Ideas arrive quickly and express themselves cleanly. Trust what you think today.",
  "mercury-mercury-square": "Mental friction or overthinking. Your mind wants to go in multiple directions at once. Pick one and stay with it.",
  "mercury-mercury-opposition": "Your current thinking is being challenged by an outside perspective or by information you did not expect. Let it revise rather than threaten.",
  "mercury-venus-conjunction": "Mercury activates natal Venus — a genuinely charming and creatively alive transit. Your words carry warmth and your ideas carry beauty. Good for love, art, and negotiation.",
  "mercury-venus-trine": "Charm and intelligence are flowing together. You express affection with unusual ease and your aesthetic sense is sharp.",
  "mercury-venus-square": "What you want to say and what will land well are briefly misaligned. Think before you speak, especially in relationships.",
  "mercury-venus-opposition": "Your way of thinking about love and beauty is being challenged or informed by someone else's perspective. Listen before you respond.",
  "mercury-mars-conjunction": "Mercury activates natal Mars — your thinking sharpens into a blade. Arguments land precisely and ideas carry unusual force. Channel this into productive confrontation rather than unnecessary conflict.",
  "mercury-mars-trine": "Mental sharpness and drive are perfectly aligned. You can argue, persuade, and act with decisive clarity. A good day for difficult conversations.",
  "mercury-mars-square": "Mental aggression or impatience with ideas. You may push your thinking faster than the situation requires. Slow down slightly.",
  "mercury-mars-opposition": "Your thinking is meeting forceful pushback from outside. The challenge is real — and it is sharpening you.",
  "mercury-jupiter-conjunction": "Mercury activates natal Jupiter — your mind expands naturally. Big ideas, philosophical conversations, and the urge to learn everything at once. Give it a direction.",
  "mercury-jupiter-trine": "Your thinking naturally reaches for meaning and possibility. Good for planning, teaching, and any communication that requires both breadth and warmth.",
  "mercury-jupiter-square": "Your mind wants to overreach — too many ideas, too much promise in the thinking. The vision is real; the execution needs more patience.",
  "mercury-jupiter-opposition": "An outside perspective is expanding (or challenging) your worldview. The broadening feels disruptive but it is actually useful.",
  "mercury-saturn-conjunction": "Mercury activates natal Saturn — your thinking becomes more disciplined and serious. Not the most inspired transit, but one of the most structurally useful. What you decide today is likely to stick.",
  "mercury-saturn-trine": "Your mind is precise, disciplined, and unusually reliable. Good for legal matters, long-term planning, and any decision that requires rigorous thinking.",
  "mercury-saturn-square": "Mental heaviness or critical self-talk. Your thinking is demanding more from you than you can deliver right now. Lower the bar slightly.",
  "mercury-saturn-opposition": "External criticism or reality is challenging your thinking. The pushback is harder than you want — and likely more accurate.",
  "mercury-uranus-conjunction": "Mercury activates natal Uranus — a genuinely electric moment for the mind. Breakthroughs, reversals, and ideas that change everything arrive suddenly. Write them down before they vanish.",
  "mercury-uranus-trine": "Original thinking comes effortlessly. Your mind is operating outside its usual tracks — go with it.",
  "mercury-uranus-square": "Mental restlessness and erratic thinking. Brilliant and scattered in equal measure. Ground the best idea before chasing the next one.",
  "mercury-uranus-opposition": "Outside disruption to your thinking — information you did not expect is forcing a recalibration. The revision is the point.",
  "mercury-neptune-conjunction": "Mercury activates natal Neptune — your thinking becomes more intuitive, poetic, and permeable. Brilliant for creative work; requires care in practical decisions.",
  "mercury-neptune-trine": "Your mind and your imagination are in genuine dialogue. Trust the poetic or intuitive impression today — it is more reliable than it looks.",
  "mercury-neptune-square": "Confusion, wishful thinking, or difficulty distinguishing fact from projection. Do not sign anything important or make irreversible decisions today.",
  "mercury-neptune-opposition": "Your thinking is being dissolved by something you cannot quite pin down. What is real and what you want to be real are asking to be distinguished.",
  "mercury-pluto-conjunction": "Mercury activates natal Pluto — a transit of psychological depth and penetrating insight. What you think today cuts through to the truth. Use this power carefully.",
  "mercury-pluto-trine": "Your mind has unusual access to what is actually happening beneath the surface. Insights about power, psychology, and hidden patterns come easily.",
  "mercury-pluto-square": "Obsessive or paranoid thinking may surface. Your mind is drilling for something — make sure the target is worth the excavation.",
  "mercury-pluto-opposition": "Someone else's words are touching something deep. What feels like manipulation may also be revelation — listen carefully.",
  "mercury-chiron-conjunction": "Mercury activates your Chiron — ideas and words that touch your oldest wound. Something you have been unable to articulate about your pain becomes speakable.",
  "mercury-chiron-trine": "You can speak about what has hurt you with unusual clarity and without flinching. This is a real and rare thing.",
  "mercury-chiron-square": "Words or information that brush against your wound. The sensitivity is real — and so is the invitation to think about this differently.",
  "mercury-chiron-opposition": "Someone else's communication is activating your deepest wound. What they say is less important than what it is pointing you toward in yourself.",

  // ── VENUS TRANSITS ────────────────────────────────────────────
  "venus-sun-conjunction": "Venus activates your natal Sun — one of the most genuinely pleasant transits of the year. You are more magnetic, more charming, and more receptive to beauty and affection. Let it in.",
  "venus-sun-trine": "Warmth, charm, and a genuine ease with yourself flow naturally. Others are responding to you with more warmth than usual — and they are right to.",
  "venus-sun-square": "A friction between what you want and who you are trying to be. You may compromise your values for harmony or sacrifice harmony for pride. Neither is necessary.",
  "venus-sun-opposition": "A relationship or external attraction is pulling against your sense of self. The mirror held up by the other person has something important to show you.",
  "venus-moon-conjunction": "Venus activates your natal Moon — emotional warmth, tenderness, and the desire for genuine connection are running high. Receive the nourishment that is available.",
  "venus-moon-trine": "Your emotional world and your capacity for love are beautifully aligned. You feel genuinely cared for and genuinely caring.",
  "venus-moon-square": "What you need emotionally and what you want in love are briefly misaligned. Notice the gap rather than filling it with the wrong thing.",
  "venus-moon-opposition": "Your emotional needs and your relationship desires are pulling against each other. The most loving thing may be to give yourself what you are seeking from others.",
  "venus-mercury-conjunction": "Venus activates natal Mercury — your words carry unusual warmth and your thinking has a genuine aesthetic quality. A good day for any communication that benefits from charm.",
  "venus-mercury-trine": "Beauty and intelligence are flowing together in your communication. What you say lands with warmth and precision.",
  "venus-mercury-square": "What you feel and what you can accurately say are briefly misaligned. The desire to be pleasing is getting in the way of being honest.",
  "venus-mercury-opposition": "Someone else's ideas are inviting you to reconsider your own values. What you love and what you think are asking to be reconciled.",
  "venus-venus-conjunction": "Venus returns to its natal position — a moment of genuine beauty, love, and self-appreciation. Receive what is available. You are unusually magnetic.",
  "venus-venus-trine": "Your capacity for love, beauty, and pleasure is running at its most natural and easy. A day to enjoy being yourself.",
  "venus-venus-square": "What you want and what actually satisfies you are briefly misaligned. The craving is real — the object may not match.",
  "venus-venus-opposition": "A relationship is showing you something about your own values and desires that only becomes visible through contrast.",
  "venus-mars-conjunction": "Venus activates natal Mars — attraction and desire are both heightened. The drive to pursue what you want and the desire to be wanted are fused. Powerful for romance and creative passion alike.",
  "venus-mars-trine": "Love and desire are in perfect sync. You know what you want and you move toward it with both warmth and courage.",
  "venus-mars-square": "A tension between what you want to attract and what you are driven to pursue. The push-pull is generating heat — which can be useful if channeled.",
  "venus-mars-opposition": "Attraction and desire are pulling in opposite directions. Someone or something is highly compelling precisely because it challenges you.",
  "venus-jupiter-conjunction": "Venus activates natal Jupiter — genuine abundance in love, beauty, and pleasure. One of the most expansively warm transits in the cycle. Receive it fully.",
  "venus-jupiter-trine": "Love and abundance flow together naturally. Your generosity is returning to you. A good day to invest in beauty, relationship, and joy.",
  "venus-jupiter-square": "Overindulgence or excess in love or pleasure. The feeling is real — the proportions may need adjusting.",
  "venus-jupiter-opposition": "Abundance or opportunity in love is meeting a reality check. What looks like expansion requires honest consideration.",
  "venus-saturn-conjunction": "Venus activates natal Saturn — love and responsibility are meeting directly. Commitments feel more serious; beauty feels earned rather than given. Good for long-term relationship decisions.",
  "venus-saturn-trine": "Love and commitment are aligned. What you build in your relationships now has genuine staying power.",
  "venus-saturn-square": "Love feels constrained or serious right now. You may feel less lovable than usual, or a relationship may feel like a burden. The weight is temporary.",
  "venus-saturn-opposition": "External responsibility or a partner's seriousness is in tension with your need for warmth and ease. The structure being asked of you is real and worth considering.",
  "venus-uranus-conjunction": "Venus activates natal Uranus — attraction to the unconventional spikes. You may feel suddenly restless in stable relationships or wildly drawn to something unexpected.",
  "venus-uranus-trine": "Your love life and your need for freedom are in perfect sync. You attract original people and unexpected beauty.",
  "venus-uranus-square": "Restlessness in love — the desire for something new or free is bumping against what you have. The impulse is pointing somewhere; the action can wait.",
  "venus-uranus-opposition": "Something unexpected is disrupting your relational world. The disruption may be exactly what was needed.",
  "venus-neptune-conjunction": "Venus activates natal Neptune — the most romantically idealistic transit possible. Everything feels transcendent and beautiful. Guard against seeing what you want rather than what is.",
  "venus-neptune-trine": "Love, beauty, and spiritual sensitivity are flowing from a genuinely inspired place. Make art. Open your heart. Let beauty in.",
  "venus-neptune-square": "Confusion or idealization in love. You may be in love with the idea of someone rather than the person. Beautiful — and requiring discernment.",
  "venus-neptune-opposition": "The dream and the reality of a relationship are being distinguished from each other. The loss of illusion is also the arrival of something real.",
  "venus-pluto-conjunction": "Venus activates natal Pluto — the most intensely transformative transit for love and desire. What you feel is deep, consuming, and revealing something important about your relationship to power.",
  "venus-pluto-trine": "Your capacity for deep, transformative love is accessible and grounded. You can love with your whole self without being consumed by it.",
  "venus-pluto-square": "Power dynamics in love surface — jealousy, obsession, or the need to control what you desire. The intensity is real. The question is what it is protecting.",
  "venus-pluto-opposition": "A relationship is triggering a deep transformation in your values and in your understanding of love itself.",
  "venus-chiron-conjunction": "Venus activates your Chiron wound in love. Old heartbreak or feelings of unworthiness surface — not to reinjure, but to be loved through.",
  "venus-chiron-trine": "Love and healing are working together. You can give and receive affection in the wounded place without it costing you everything.",
  "venus-chiron-square": "A relationship or desire is brushing against your oldest wound around love. The tenderness is pointing toward what still needs care.",
  "venus-chiron-opposition": "Someone or something in your love life is activating your deepest wound around deserving. The mirror they hold is worth looking into.",

  // ── MARS TRANSITS ─────────────────────────────────────────────
  "mars-sun-conjunction": "Mars activates your natal Sun — a surge of raw energy, drive, and sometimes ego. You feel more powerful and more impatient than usual. Use this transit to initiate rather than to fight.",
  "mars-sun-trine": "Your drive and your identity are perfectly aligned. You move through obstacles with ease and authority. Start what matters.",
  "mars-sun-square": "Tension between your ego and your drive is generating friction. You may feel blocked, frustrated, or in conflict with authority. The obstacle is not the enemy — it is the teacher.",
  "mars-sun-opposition": "Your will is meeting direct opposition. A confrontation — internal or external — is asking you to clarify what you actually stand for.",
  "mars-moon-conjunction": "Mars activates your natal Moon — emotions become physical and drive becomes emotionally charged. Powerful for action taken from a place of genuine care. Watch for reactivity.",
  "mars-moon-trine": "Your emotional drive and your assertiveness are in sync. You can act from the heart without losing your edge.",
  "mars-moon-square": "Emotional reactivity spikes. Anger, impatience, or a sense that your needs are not being met. The feeling is real — the response needs space.",
  "mars-moon-opposition": "Your drive and your emotional needs are pulling in opposite directions. What you need to do and what you need to feel are briefly incompatible.",
  "mars-mercury-conjunction": "Mars activates natal Mercury — your thinking sharpens to a blade. Arguments are precise and persuasive. Good for debate, negotiation, and any communication that requires force.",
  "mars-mercury-trine": "Mental drive and precision are running high together. You think fast, argue well, and act on your ideas without hesitation.",
  "mars-mercury-square": "Mental aggression or hasty communication. Think before you send the message. The point you are making may be valid — the delivery needs calibration.",
  "mars-mercury-opposition": "Your ideas are meeting direct challenge. The debate is worth having — it is sharpening your thinking even as it frustrates you.",
  "mars-venus-conjunction": "Mars activates natal Venus — desire, attraction, and the drive to pursue what you want are all heightened together. One of the most powerful transits for romantic passion.",
  "mars-venus-trine": "Desire and love are in perfect alignment. You know what you want and you move toward it with both warmth and decisiveness.",
  "mars-venus-square": "Tension between what you desire and what you can actually have. The frustration is pointing toward something real about your needs.",
  "mars-venus-opposition": "Your desire is meeting an equally powerful counter-force. The tension between attraction and resistance is generating real heat.",
  "mars-mars-conjunction": "Mars returns to its natal position — your Mars return. Drive, ambition, and raw energy are at their annual peak. What you initiate now carries unusual force.",
  "mars-mars-trine": "Your drive is operating at its most natural and effective. Physical energy is high and your capacity for sustained effort is exceptional.",
  "mars-mars-square": "Your drive is meeting itself — frustration, blocked energy, or a sense that your efforts are not producing results. The obstacle is directing you somewhere more productive.",
  "mars-mars-opposition": "Your drive is meeting powerful external opposition. The confrontation is clarifying what you actually want and what you are willing to fight for.",
  "mars-jupiter-conjunction": "Mars activates natal Jupiter — energy and optimism spike together. You feel like you can take on anything. You might be right — but pick the thing that actually matters.",
  "mars-jupiter-trine": "Drive and opportunity are working together perfectly. Bold action is supported. Go.",
  "mars-jupiter-square": "Energy and ambition are overextending — you are reaching further than your current resources support. The vision is real; the timeline needs adjustment.",
  "mars-jupiter-opposition": "Your drive is encountering expansion or opportunity that requires you to recalibrate your direction. The offer is genuine — but so are its demands.",
  "mars-saturn-conjunction": "Mars activates natal Saturn — drive meets structure, and the result is either extraordinary discipline or frustrating blockage. The effort required is real and so is what it is building.",
  "mars-saturn-trine": "Drive and discipline are perfectly aligned. You can sustain effort over time without burning out. A powerful transit for long-term projects.",
  "mars-saturn-square": "Energy and restriction are in direct confrontation. You feel blocked or forced to slow down. What is being delayed is being preserved.",
  "mars-saturn-opposition": "External authority or reality is blocking your drive. The resistance is real — and it may be pointing toward a smarter direction.",
  "mars-uranus-conjunction": "Mars activates natal Uranus — one of the most explosive transits possible. Sudden action, rebellion, or a breakthrough that changes everything. Channel this carefully.",
  "mars-uranus-trine": "Originality and drive are working together. You act on the unconventional impulse and it actually works.",
  "mars-uranus-square": "Impulsive or erratic energy. The urge to break free from constraint is real — but the action wants more thought than this transit provides.",
  "mars-uranus-opposition": "External disruption is activating your drive in unexpected ways. Something is breaking open — go with the change rather than fighting it.",
  "mars-neptune-conjunction": "Mars activates natal Neptune — drive and imagination become intertwined. Inspired action is possible; scattered or deluded action is equally possible. Trust your gut, not your wishful thinking.",
  "mars-neptune-trine": "Your drive is being guided by something deeper than strategy. Inspired, intuitive action is available. Trust the pull.",
  "mars-neptune-square": "Confusion about what to pursue or why. Your energy may feel scattered, misdirected, or used up by things that do not matter. Come back to what is actually real.",
  "mars-neptune-opposition": "Your drive is meeting something diffuse and hard to pin down. The obstacle is not what it appears. Look deeper.",
  "mars-pluto-conjunction": "Mars activates natal Pluto — the most intensely powerful drive transit possible. Obsessive focus, ruthless efficiency, or the urge to destroy and rebuild. This is a force — direct it consciously.",
  "mars-pluto-trine": "Transformative drive is running cleanly. You have access to a focused, powerful energy that can move mountains — use it on what actually deserves this level of commitment.",
  "mars-pluto-square": "Power, control, and force are in direct confrontation. The struggle is real — and it is demanding that you become more conscious of how you use your drive.",
  "mars-pluto-opposition": "External power is meeting your drive with equal force. The confrontation is asking you to see your own power dynamics more clearly.",
  "mars-chiron-conjunction": "Mars activates your Chiron wound — old pain around action, courage, or worthiness surfaces. The wound is not reopening; it is asking to be acted from rather than around.",
  "mars-chiron-trine": "Your drive and your wound are working together. The courage it takes to act through the tender place is available right now.",
...
const dailyHoroscopes = {
  Aries:[
    "Something you have been carrying about who you are supposed to be is finally starting to feel optional. The version of yourself that is emerging does not need a label yet. Let it take shape on its own terms — it is more you than anything you have worn before.",
    "The financial momentum you have been grinding toward is real and it is building. The pace might feel slower than you want but what is coming together right now is built to last. Do not rush the process — the solidity is the point.",
    "A conversation you have been avoiding is actually your fastest route to something better. Say the true version today. It is going to land cleaner than the polished one and the air on the other side is genuinely good.",
    "Look around at who you are spending your energy on. Some of those connections have quietly outgrown their fit and you already know which ones. Getting more intentional about your circle is not harsh — it is honest.",
    "Something about your home life or private world is shifting toward more warmth and more realness this week. Let the people who are closest to you actually see you. The version of you they get to see is worth showing.",
    "Write everything down right now — ideas, half-thoughts, things that feel too big to say out loud. One of the threads you are pulling on is more significant than it appears on the surface. You will want to be able to find it later.",
    "The discipline you are building in yourself right now is not about restriction. It is about learning to act on your instincts with intention instead of just impulse. That is a permanent upgrade and it is happening whether you notice or not.",
  ],
  Taurus:[
    "You can feel a steadier, more deliberate kind of drive building underneath everything you do right now. You are not in a hurry and that is exactly right. What you are constructing this season is meant to last and the pace is appropriate.",
    "Something you worked for quietly and consistently is about to pay off in a way you can actually hold onto. The gifts being arranged for you are becoming visible. Let yourself receive them without immediately looking for the catch.",
    "What do you actually want to own, build, and call yours? This is a genuinely good week to get honest about what you are working toward — not the answer that sounds right but the one that is true. Start there.",
    "Say the warmer version of the thing today. There is a conversation in your life that needs a little more tenderness and a little less strategy. The people around you are ready to receive it and it is going to mean more than you think.",
    "An unexpected shift in how you earn or where money comes from is quietly forming. Stay flexible about what that looks like. What feels disruptive right now is actually making room for a model that fits you better.",
    "Old power structures in your professional life are loosening and what you build in their place is going to actually reflect who you have become — not who you were when you started. That replacement is worth the instability.",
    "A money decision you shelved a few months ago deserves another look right now. The clarity you were waiting for then is actually available now. Run the numbers again with fresh eyes before you close that door permanently.",
  ],
  Gemini:[
    "Something about how you are presenting yourself to the world is ready for a genuine upgrade. Your birthday season this year carries a charge to it — an electric, change-making energy that is asking you to step into a version of yourself that is more fully realized.",
    "The thing you have been trying to articulate — the idea, the pitch, the feeling — say it today. Your words are landing with unusual precision and power right now. The real version is going to come out exactly right.",
    "Your best moves this season are the quiet ones. Work behind the scenes, let things develop without announcing them, and resist the urge to show your hand too early. The less you broadcast right now, the more effective you are going to be.",
    "Something you genuinely value is becoming more available to you financially. Money can flow toward what you love when you stop apologizing for loving it. Give yourself permission to want what you actually want.",
    "A belief or worldview that was handed to you rather than chosen by you is being pulled apart right now — and what is replacing it is genuinely, authentically yours. Give that new perspective space to form before you start defending it.",
    "You are being asked to get more intentional about who has access to your energy. Not every friendship or community connection deserves what it is currently receiving from you. The audit is overdue and the results will feel like relief.",
    "Something fundamental about your identity is quietly updating right now — what felt fixed about you is becoming negotiable in the best possible way. Do not cling to the old version. The new one fits better.",
  ],
  Cancer:[
    "You are in a genuine glow period right now — more magnetic, more emotionally available, more able to receive what you actually deserve. Let people see you this week. Let the good things land instead of deflecting them.",
    "Some of your most powerful work right now is happening in solitude — in the quiet processing you do before the world sees anything. Trust that. The behind-the-scenes work is not invisible, it is the foundation of everything that comes next.",
    "A group effort or collective project you are part of is about to gain serious momentum. Your steady, consistent contribution has been noticed more than you know. The payoff on that patience is getting close.",
    "Old dynamics around what you give and what you are owed in your closest relationships are being permanently renegotiated right now. Let the honest version of that conversation win. What replaces the old arrangement is more real.",
    "Something that usually lives in the feeling space without words is coming into language for you right now. Write it down before it retreats back into the blur. This clarity is temporary and it is worth capturing.",
    "A door that opened over the last year in your professional life is ready to be walked through fully. Stop pausing at the threshold looking for reasons to wait. The moment to go all the way in is right now.",
    "The professional path that used to feel like enough is being pushed to become something more intentional and more truly yours. The discomfort you feel around your career right now is not a warning sign — it is a compass.",
  ],
  Leo:[
    "Your ideas, your voice, your visibility at work are all amplified right now. This is not the week to stay quiet about what you know or what you see. Speak up in the room. Your perspective is the one that is missing.",
    "Old relationship patterns — the ways you have been showing up with people that no longer actually fit — are being permanently revised right now. What survives that honest look is real. What does not survive needed to go.",
    "The professional move you have been carefully and quietly preparing for is closer to ready than it feels. One more deliberate, unhurried step and it lands. Do not rush it and do not abandon it. The timing is almost exactly right.",
    "Something you have been protecting in your inner world is ready to be shared with someone who has genuinely earned it. The vulnerability you have been holding back is not a liability right now — it is where your power is.",
    "Your ideas are landing with real clarity and authority in professional settings this week. The pitch, the proposal, the thing you have been building a case for — bring it. The timing is excellent and people are ready to receive it.",
    "An opportunity that does not look like what you were expecting still has your name on it. Stay open to the unconventional path right now. The thing that arrives sideways is the one worth serious consideration.",
    "What you have built professionally over the last year is more real and more valuable than it currently looks to you. Do not underestimate the foundation. It is more solid than you are giving it credit for.",
  ],
  Virgo:[
    "Something unexpected and genuinely exciting is activating in your professional life right now. Stay flexible about what that looks like — the surprise is actually the upgrade. The version you did not plan for is the better one.",
    "A belief or long-term vision you have been quietly developing is ready to become a real direction. Trust the worldview that has been forming in you. It is more solid than it feels and it is time to start moving toward it.",
    "The habits that have been draining you are finally losing their grip. What replaces them is going to actually serve the person you are becoming — not the person you used to be. Let the old routine go without guilt.",
    "A friendship or connection that has been growing quietly is ready to become something more clearly defined. Say the truer, warmer thing. They are ready to hear it and the relationship is ready to deepen.",
    "The memo, the proposal, the email that has been sitting in your drafts — send it this week. Your thinking is landing with unusual clarity and authority right now. Do not sit on it any longer. It is ready.",
    "The standards for what you are willing to commit to in partnership are getting clearer, not stricter. You are learning the difference between real compromise and quietly selling yourself short. That distinction is going to serve you well.",
    "A perspective that has been slowly growing in you over the last year is about to become a genuine conviction. Let it solidify. The wisdom you have been accumulating quietly is ready to become something you actually stand on.",
  ],
  Libra:[
    "Old ways of performing, pleasing, and presenting yourself in love are being permanently retired right now. What is emerging in their place is more real, more compelling, and far more sustainable. Let the authentic version take over.",
    "A professional relationship is warming up in a meaningful way. Someone with genuine influence in your world is on your side right now — more than they may have said out loud. Let them help. You do not have to do this part alone.",
    "The belief that has been forming quietly in you is ready to be said out loud this week. Your perspective is going to resonate with people who need to hear exactly what you are seeing. Do not keep it to yourself any longer.",
    "Something you have been avoiding dealing with emotionally is becoming easier to face right now. The timing is actually right. Moving toward it this week is going to feel hard for about five minutes and then like an enormous relief.",
    "An idea or opportunity coming from an unexpected direction has real potential. The unconventional version of the plan is the one worth seriously considering. Do not dismiss it just because it does not look like what you expected.",
    "The discipline you are building into your daily routines right now is not punishment — it is the architecture of a more functional, more sustainable life. What feels like restriction today is going to feel like freedom in six months.",
    "Something you confronted bravely over the last year has genuinely transformed you. The person on the other side of that experience is stronger and more honest. Let yourself appreciate how far you have actually come.",
  ],
  Scorpio:[
    "Something connected to where you came from — old family wounds, old home dynamics, old origin stories — is surfacing right now to be healed properly, not just managed. This is not a setback. This is the real work finally being done.",
    "Something you believe in is finding an audience. A message or idea you carry is ready to travel further than it has before. The reach that is available to you right now is real — give it the push it needs.",
    "A relationship — romantic or professional — is reaching a point of genuine definition. The conversation that clarifies everything between you is ready to happen. Stop circling it. The direct version is the kindest version.",
    "Information that was not available to you before is becoming accessible right now. What you discover this week is going to shift your strategy in a significant way. Stay curious and keep looking — what is hidden is close to the surface.",
    "The gap between how you want to show up in your daily life and how you actually operate is closing right now. The habits that match your real ambitions are replacing the ones that were just comfortable. Let that shift happen.",
    "An old financial arrangement or agreement that has been running on autopilot is due for a real look. The version that replaces it will be more honest and more aligned with who you actually are now. Do not keep the old deal out of habit.",
    "A collaboration or commitment that has been developing slowly is about to become real and tangible. Receive it with both hands. What is arriving is the result of patience you may have forgotten you were practicing.",
  ],
  Sagittarius:[
    "A long chapter of slow, practical, earthy growth is wrapping up and the patience it demanded of you has paid off in ways you can now actually count and hold. Take a real look at what you have built. It is more than it felt like while you were building it.",
    "A key one-on-one relationship — personal or professional — is asking for honesty and clarity right now. The direct conversation is the shortcut, not the long way around. Stop rehearsing it and just have it. It goes better than you think.",
    "Old patterns in how you communicate — the ways you have been speaking and being spoken to that no longer serve you — are being permanently restructured. What you say with full intention from here lands completely differently.",
    "A project that has required unglamorous, consistent, unflashy effort is about to reach a visible milestone. Do not abandon the process right before the payoff. The breakthrough is closer than it feels and it is coming because of everything you put in.",
    "Something that has been emotionally closed off in your closest relationships is becoming available again. Let it open at the pace it wants to open. Do not force it and do not retreat from it. Just stay present and let it move.",
    "A relationship dynamic that was no longer working is being broken open right now — and the disruption, as uncomfortable as it is, is making room for something more honest to exist in its place. That is worth the turbulence.",
    "You are being asked some hard questions about where you truly belong and what foundation you are actually building your life on. The honest answer to those questions leads somewhere better than the comfortable one does.",
  ],
  Capricorn:[
    "Old money stories — the ones you inherited rather than chose — are being permanently revised right now. The beliefs about what you are allowed to have and what you are worth are being rewritten. Write the new version yourself before someone else does.",
    "Something you are making is getting better every single day in a way that is quietly, deeply satisfying. Stay in the creative process right now. The work is building toward something that is going to genuinely surprise you.",
    "A systems-level problem you have been circling for a while is finally ready to be solved. The solution is more straightforward than you have been making it. Step back, look at the actual structure, and make the obvious fix.",
    "A relationship that has been tested is becoming more honest and more solid through exactly what it is going through. What you are moving toward together is real. The difficulty is not evidence it is failing — it is evidence it is deepening.",
    "The way you articulate what you know and what you need is being upgraded right now. The more honest, less armored version of your voice is the one that lands with actual authority. Try it this week and notice the difference.",
    "Something you have been developing with patience and genuine craft is nearly finished. The final push is worth everything — do not let fatigue or doubt pull you away at the last stretch. Stay in it and see it through.",
    "An unexpected shift in how or where you work is quietly forming. The version on the other side of that disruption is more aligned with who you actually are now than what you currently have. Stay open to what is coming.",
  ],
  Aquarius:[
    "Old versions of yourself that you have been holding onto out of comfort rather than actual truth are ready to be released. The renovation of your identity is entering a crucial phase. Let the update happen. The new version is not a departure — it is an arrival.",
    "An idea you have been sitting on is ready to come out into the world this week. Make something. Say something. The timing is genuinely good and the world is more ready to receive this than you have been giving it credit for.",
    "A change in your home life or living situation is building slowly and deliberately right now. The pace is correct. Do not try to accelerate it and do not resist it. What is being constructed here is meant to hold for a long time.",
    "Small pleasures built into your daily routine are medicine right now — not indulgences. Your body knows what it needs and it is asking for it. Listen without arguing. The nourishment you give yourself this week is going to matter.",
    "Something is shifting in your relationship to what you believe you are worth and what you are allowed to have. New financial discipline is becoming second nature. The story you are living now is different from the one you inherited.",
    "Something that shifted in your home or family life over the last year is stabilizing into something you can actually stand on. Appreciate what has been built. The foundation is more solid than it looks from where you are standing.",
    "The project that breaks your usual pattern is the one with the most momentum right now. Follow the unexpected thread. The thing that excites and slightly terrifies you simultaneously is the direction worth moving toward.",
  ],
  Pisces:[
    "The weight you have been carrying in your daily structure is real — but so is the architecture it is building in you. What is being forged right now is a backbone that is going to serve you for a very long time. Hold the line.",
    "The dream that has been floating in you without a body is starting to want one. Your spiritual energy is shifting toward action and initiation in a new way. Give that impulse one concrete step this week. Just one. That is enough to start.",
    "A conversation about where you live, who you live near, or where you truly belong is ready to happen. Say what is actually true about what you need and want from your home life. The honest version opens the right doors.",
    "Something you make from the heart this week lands with genuine resonance. The emotional truth in your work is the most powerful thing about it — not the polish, not the presentation, the truth. Lead with that.",
    "A message you have been composing in your head is ready to be sent. The slower, more considered version is the right one — not the fast, reactive version. Write it carefully and then send it. It is time.",
    "Something that has been running quietly in the background for years is surfacing right now — and it is not here to hurt you. It is here to be finished. The thing rising is ready to be resolved, not re-experienced. That is the difference.",
    "A skill or body of knowledge you have been building quietly over the last year is nearly ready to be put to real use. Do not keep it to yourself much longer. The application you have been preparing for is closer than it seems.",
  ],
};
...
// ── Compact planet row for 2-col grid ───────────────────────────
function PlanetRow({ planet, sign, fact }) {
  const [expanded, setExpanded] = useState(false);
  const color = colors[sign] || "#f5c842";
  return (
    <div onClick={() => setExpanded(e => !e)}
      style={{background:`linear-gradient(135deg,${color}10,rgba(0,0,0,0.25))`,border:`1px solid ${color}${expanded?"66":"30"}`,borderRadius:12,padding:"12px 14px",cursor:"pointer",transition:"all 0.2s",position:"relative",overflow:"hidden"}}>
      <div style={{position:"absolute",top:0,left:0,right:0,height:2,background:`linear-gradient(90deg,transparent,${color},transparent)`,opacity:expanded?1:0.4}}/>
      <div style={{display:"flex",alignItems:"center",gap:8}}>
        <span style={{fontSize:18,flexShrink:0}}>{emojis[planet]}</span>
        <div style={{flex:1,minWidth:0}}>
          <div style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:8,color,letterSpacing:".1em",marginBottom:1}}>{planet.toUpperCase()}</div>
          <div style={{fontFamily:"'Cinzel',serif",fontWeight:900,fontSize:12,color:"#f5f0e0",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{emojis[sign]} {sign}</div>
        </div>
        <span style={{fontSize:8,color,opacity:0.5,transform:expanded?"rotate(180deg)":"rotate(0deg)",transition:"transform 0.2s",flexShrink:0}}>▼</span>
      </div>
      {expanded && fact && (
        <div style={{marginTop:10,paddingTop:10,borderTop:`1px solid ${color}20`,fontFamily:"Georgia,serif",fontSize:12,color:"#c8b890",lineHeight:1.6,animation:"up 0.2s ease"}}>
          {fact}
        </div>
      )}
    </div>
...
function BigThreeCard({ planet, sign }) {
  const color = colors[sign] || "#f5c842";
  const labels = { Sun:"Your Identity", Moon:"Your Emotions", Rising:"How You Appear" };
  return (
    <div style={{flex:1,background:`linear-gradient(160deg,${color}20,rgba(0,0,0,0.4))`,border:`1px solid ${color}55`,borderRadius:16,padding:"16px 12px",textAlign:"center",position:"relative",overflow:"hidden"}}>
      <div style={{position:"absolute",top:0,left:0,right:0,height:2,background:`linear-gradient(90deg,transparent,${color},transparent)`}}/>
      <div style={{fontSize:26,marginBottom:6}}>{emojis[sign]}</div>
      <div style={{fontFamily:"'Cinzel',serif",fontWeight:900,fontSize:15,color,marginBottom:2}}>{sign}</div>
      <div style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:8,color:"#a8e060",letterSpacing:".1em",marginBottom:6}}>{planet.toUpperCase()}</div>
      <div style={{fontFamily:"Georgia,serif",fontSize:10,color:"#6a6058",lineHeight:1.4}}>{labels[planet]}</div>
    </div>
  );
}
...
function AspectWheel({ aspects, chartPlanets, report }) {
  ...
  const filtered = (aspects || []).filter(a => {
    ...
    return MAJOR_TYPES.includes(type) &&
      !SKIP_BODIES.some(s => p1.includes(s) || p2.includes(s));
  });
  ...
  const aspectColor = (type) => {
    const t = (type||"").toLowerCase();
    if (t === "trine") return "#a8e060";
    if (t === "sextile") return "#5bc8d8";
    if (t === "conjunction") return "#f5c842";
    if (t === "opposition") return "#ff6b6b";
    if (t === "square") return "#ff9944";
    return "#a8c0d8";
  };
  const aspectSymbol = (type) => {
    const t = (type||"").toLowerCase();
    if (t === "trine") return "△";
    if (t === "sextile") return "⚹";
    if (t === "conjunction") return "☌";
    if (t === "opposition") return "☍";
    if (t === "square") return "□";
    return "✦";
  };

  // Build unique planet list from filtered aspects
  const planetSet = new Set();
  filtered.forEach(a => { planetSet.add(a.planet1); planetSet.add(a.planet2); });
  const planetList = [...planetSet].slice(0, 12);
  ...
  return (
    <div style={{marginBottom:24}}>
      ...
      <div style={{fontFamily:"Georgia,serif",fontSize:11,color:"#4a4440",textAlign:"center",marginBottom:14}}>Tap a line to read the aspect</div>

      {/* Aspect legend */}
      <div style={{display:"flex",flexWrap:"wrap",gap:8,justifyContent:"center",marginBottom:14}}>
        {[["trine","△","#a8e060"],["sextile","⚹","#5bc8d8"],["conjunction","☌","#f5c842"],["opposition","☍","#ff6b6b"],["square","□","#ff9944"]].map(([name,sym,col])=>(
          <div key={name} style={{display:"flex",alignItems:"center",gap:4}}>
            <span style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:12,color:col}}>{sym}</span>
            <span style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:8,color:"#4a4440",letterSpacing:".06em"}}>{name}</span>
          </div>
        ))}
      </div>
      ...
      <div style={{display:"flex",justifyContent:"center",marginBottom:16}}>
        <svg width={SIZE} height={SIZE} viewBox={`0 0 ${SIZE} ${SIZE}`}>
          {/* Outer ring */}
          <circle cx={CX} cy={CY} r={R+DOT_R} fill="none" stroke="rgba(255,200,50,0.08)" strokeWidth="1"/>
          <circle cx={CX} cy={CY} r={R-DOT_R/2} fill="none" stroke="rgba(255,200,50,0.05)" strokeWidth="1"/>

          {/* Aspect lines */}
          {filtered.map((a, i) => {
            const i1 = planetList.indexOf(a.planet1);
            const i2 = planetList.indexOf(a.planet2);
          ...
          {planetList.map((planet, i) => {
            const pos = planetPos(i);
            const sign = chartPlanets[planet];
            const color = (sign && colors[sign]) || "#f5c842";
            return (
              <g key={planet}>
                <circle cx={pos.x} cy={pos.y} r={DOT_R} fill={`${color}22`} stroke={`${color}88`} strokeWidth="1"/>
                <text x={pos.x} y={pos.y+1} textAnchor="middle" dominantBaseline="middle" fontSize="12">{emojis[planet]||"✦"}</text>
              </g>
            );
          })}
        </svg>
...
const houseDescriptions = {
                1: { Aries: "Aries on your 1st house cusp means Mars rules your entire chart and your identity. You lead with action, confidence, and a directness that people feel immediately. At your best you are courageous, alive, and impossible to ignore.", Taurus: "Taurus on your 1st house cusp means Venus rules your chart and your identity. You move through the world slowly, deliberately, and with a quiet magnetism that draws people in. At your best you are reliable, beautiful in the truest sense, and someone others want to be near.", Gemini: "Gemini on your 1st house cusp means Mercury rules your chart and your identity. You present yourself as quick, curious, and intellectually alive. At your best you are one of the most stimulating people in any room.", Cancer: "Cancer on your 1st house cusp means the Moon rules your chart and your identity. Your outer presentation is warm, receptive, and instinctively attuned to the emotional atmosphere around you. At your best you are one of the most genuinely nurturing presences anyone will encounter.", Leo: "Leo on your 1st house cusp means the Sun rules your chart and your identity. You were built to be seen — there is a warmth, a radiance, and a natural authority to how you enter a room. At your best you are genuinely inspiring — someone who makes others feel like their own light is worth shining.", Virgo: "Virgo on your 1st house cusp means Mercury rules your chart and your identity. You present yourself with precision, intelligence, and a quiet discernment that makes people sense immediately that you are noticing things. At your best you are the person others bring their real problems to.", Libra: "Libra on your 1st house cusp means Venus rules your chart and your identity. You present yourself with grace, social intelligence, and a natural attentiveness to other people. At your best you are someone who brings genuine beauty and balance into every environment you enter.", Scorpio: "Scorpio on your 1st house cusp means Mars and Pluto rule your chart and your identity. Your first impression is magnetic, penetrating, and quietly powerful. At your best you are one of the most compelling and transformative presences anyone will encounter.", Sagittarius: "Sagittarius on your 1st house cusp means Jupiter rules your chart and your identity. You present yourself with enthusiasm, openness, and a warmth that makes people feel like the world just got bigger. At your best you remind others that meaning is real and that the horizon is always worth moving toward.", Capricorn: "Capricorn on your 1st house cusp means Saturn rules your chart and your identity. You present yourself with composure, seriousness, and a quiet authority that makes people sense immediately that you have earned your place. At your best you are someone whose respect people genuinely want to earn.", Aquarius: "Aquarius on your 1st house cusp means Saturn and Uranus rule your chart and your identity. You present yourself as original, intellectually alive, and slightly outside the mainstream. At your best you make others feel like their most original self is the one worth being.", Pisces: "Pisces on your 1st house cusp means Jupiter and Neptune rule your chart and your identity. You present yourself with a softness, a permeability, and a dreamlike quality. At your best your presence feels like a genuine encounter with something larger and more tender than ordinary life." },
                2: { Aries: "Aries on your 2nd house cusp brings a bold, impulsive energy to how you earn and spend money. You take initiative and trust your instincts about when to move. At your best you build wealth through courage and initiative that more cautious people simply cannot access.", Taurus: "Taurus on your 2nd house cusp is the natural ruler in its home — one of the most powerful positions for building lasting material security. You have an instinctive relationship with quality, value, and the physical world. At your best you create a life of genuine beauty and solidity that others find deeply sustaining.", Gemini: "Gemini on your 2nd house cusp means your income and self-worth are tied to your mind and your ability to communicate. You may have multiple income streams and you are resourceful and adaptable with money. At your best you turn your intelligence and communication gifts directly into livelihood.", Cancer: "Cancer on your 2nd house cusp means financial and emotional security are deeply intertwined for you. When your bank account feels stable, you feel emotionally safe. At your best you build genuine material security rooted in the things that actually matter to you.", Leo: "Leo on your 2nd house cusp means your earning power is connected to your creativity, visibility, and sense of personal worth. At your best you build wealth through your creative gifts and your willingness to be fully, visibly yourself.", Virgo: "Virgo on your 2nd house cusp means you approach money with precision, care, and an attention to detail that most people do not bring to their finances. At your best you build financial security through genuine mastery and reliable, detailed work.", Libra: "Libra on your 2nd house cusp means your finances are often connected to partnerships, relationships, and your sense of aesthetic value. At your best you build wealth through your gifts for connection, beauty, and genuine collaboration.", Scorpio: "Scorpio on your 2nd house cusp brings an intense, all-or-nothing energy to money and self-worth. You have a gift for finding resources in hidden places. At your best you have an extraordinary capacity to transform financial situations that others have written off.", Sagittarius: "Sagittarius on your 2nd house cusp means your relationship with money is optimistic, expansive, and occasionally reckless. Your earning tends to come through philosophy, education, travel, or publishing. At your best your faith in the future becomes genuinely self-fulfilling.", Capricorn: "Capricorn on your 2nd house cusp means you approach money with discipline, patience, and a long-term orientation. You build wealth steadily over time. At your best you build financial security that is genuinely solid and genuinely yours.", Aquarius: "Aquarius on your 2nd house cusp means your relationship with money is unconventional — you may earn in unusual ways. You are not particularly motivated by money for its own sake. At your best you create financial models that serve both your independence and your contribution to something larger.", Pisces: "Pisces on your 2nd house cusp means your relationship with money is fluid, intuitive, and occasionally confused. Your earning is often connected to creative, spiritual, or healing work. At your best your financial life is sustained by the genuine depth and value of what you offer to the world." },
                3: { Aries: "Aries on your 3rd house cusp means your mind moves fast, your communication is direct, and your thinking is built for action. You learn best by doing. At your best you are one of the most mentally alive and catalyzing communicators in any room.", Taurus: "Taurus on your 3rd house cusp means your mind moves slowly, deliberately, and almost always correctly. You think things through before speaking, which means your words carry weight when they arrive. At your best you are the most reliable and grounded voice in any conversation.", Gemini: "Gemini on your 3rd house cusp is the natural ruler in its home, giving you one of the most naturally agile and curious minds in the zodiac. You think in connections, questions, and possibilities. At your best you bring a sparkling, generative intelligence to everything you say.", Cancer: "Cancer on your 3rd house cusp means your thinking is intuitive, emotionally intelligent, and deeply influenced by memory and feeling. You remember how things felt more than what was said. At your best you communicate with a genuine empathy that makes people feel truly understood.", Leo: "Leo on your 3rd house cusp means you communicate with confidence, warmth, and a natural dramatic flair. You think in stories. At your best you are one of the most compelling communicators in any room.", Virgo: "Virgo on your 3rd house cusp means your mind is precise, analytical, and oriented toward what is actually true. You communicate with a clarity and specificity that is genuinely rare. At your best you are the most reliable intellectual resource in any environment.", Libra: "Libra on your 3rd house cusp means your mind is naturally diplomatic, fair, and extraordinarily good at seeing every perspective. At your best you are one of the most skilled communicators in any context.", Scorpio: "Scorpio on your 3rd house cusp means your mind goes beneath the surface automatically. You read subtext, body language, and what is conspicuously absent. At your best you are one of the most penetrating and psychologically astute minds in any room.", Sagittarius: "Sagittarius on your 3rd house cusp means your mind reaches naturally toward the big picture and the philosophical question. You communicate with enthusiasm and breadth. At your best you are one of the most genuinely inspiring communicators in any context.", Capricorn: "Capricorn on your 3rd house cusp means your mind is strategic, disciplined, and oriented toward what is actually useful. Your communication is economical — you do not use ten words when four will do. At your best you are the most reliable and substantive voice in any conversation.", Aquarius: "Aquarius on your 3rd house cusp means your mind operates outside the mainstream almost by default. You see patterns and systems rather than individual cases. At your best you are one of the most original and catalyzing minds in any room.", Pisces: "Pisces on your 3rd house cusp means your mind thinks in images, feelings, and impressions rather than linear logic. Your communication has a poetic quality that is simply how you process the world. At your best you are one of the most evocative and resonant communicators in any context." },
                4: { Aries: "Aries on your 4th house cusp means your home life and family history carry a strong energy of independence, conflict, and initiation. Home for you is a place of activity rather than stillness. At your best you create a home that is energized and alive.", Taurus: "Taurus on your 4th house cusp means home is your deepest sanctuary and your most essential need. You require a physical environment of beauty, comfort, and genuine stability. At your best you create a home of extraordinary warmth and solidity that nourishes everyone who enters it.", Gemini: "Gemini on your 4th house cusp means your home life is characterized by movement, conversation, and intellectual energy. Your sense of roots is more mental than physical. At your best your home is a hub of lively exchange.", Cancer: "Cancer on your 4th house cusp is the natural ruler in its home — this intensifies everything connected to home, family, and emotional security. Your roots run extraordinarily deep. At your best you create a home of genuine emotional safety that heals not just you but everyone in it.", Leo: "Leo on your 4th house cusp means your home is a place of warmth, drama, and self-expression. You need your private life to feel special. At your best your home is a genuine sanctuary of joy and creativity.", Virgo: "Virgo on your 4th house cusp means your home and private life are organized around order, function, and the desire to improve. At your best your home is a model of thoughtful, functional beauty that genuinely supports your wellbeing.", Libra: "Libra on your 4th house cusp means your home and family life are organized around harmony, beauty, and the desire for balance. At your best your home is a place of genuine beauty and mutual care.", Scorpio: "Scorpio on your 4th house cusp brings an intense, transformative energy to your home, family, and deepest psychological roots. Home is where your deepest psychological work happens. At your best your home is a site of genuine healing.", Sagittarius: "Sagittarius on your 4th house cusp means your home and family roots carry a strong energy of freedom, philosophy, and expansion. Your sense of home is not tied to a fixed place. At your best your private life is rich with meaning.", Capricorn: "Capricorn on your 4th house cusp means your home life and family foundation are characterized by structure, responsibility, and high expectations. At your best you create a home of lasting solidity that provides real security for everyone in it.", Aquarius: "Aquarius on your 4th house cusp means your home and family life have always been unconventional. Your sense of home is tied to community and shared ideals. At your best you create a home that is both free and genuinely connected.", Pisces: "Pisces on your 4th house cusp means your home and family roots are characterized by deep sensitivity, spiritual awareness, and fluid boundaries. At your best your home is a place of extraordinary gentleness and spiritual depth." },
                5: { Aries: "Aries on your 5th house cusp means you approach creativity, romance, and joy with boldness, immediacy, and a competitive edge. You fall in love fast and pursue what you want without hesitation. At your best you bring a fearless, life-giving energy to everything you create and everyone you love.", Taurus: "Taurus on your 5th house cusp means your approach to creativity and romance is sensual, patient, and deeply pleasurable. You create slowly and with great care, producing things of lasting beauty. At your best you produce creative work of extraordinary beauty and endurance.", Gemini: "Gemini on your 5th house cusp means creativity and romance are fueled by intellectual stimulation and variety. You are attracted to minds and your creative process thrives on curiosity and play. At your best you bring a sparkling, generative intelligence to everything you create.", Cancer: "Cancer on your 5th house cusp means your creativity and romantic life are deeply emotional and instinctively protective. Your best creative work comes from genuine emotional resonance. At your best you create with a tenderness and depth that genuinely moves people.", Leo: "Leo on your 5th house cusp is the natural ruler in its home — this amplifies everything connected to joy, creativity, romance, and self-expression. You were built to create, to love dramatically, and to play fully. At your best you are one of the most genuinely alive and creatively powerful people in any room.", Virgo: "Virgo on your 5th house cusp means your approach to creativity and romance is careful, discerning, and oriented toward craft and improvement. At your best the precision and devotion you bring to creative work produces something genuinely excellent.", Libra: "Libra on your 5th house cusp means creativity and romance are both tied to beauty, partnership, and the pursuit of genuine harmony. At your best you create work of genuine elegance and form romantic connections of real depth.", Scorpio: "Scorpio on your 5th house cusp means your creativity and romantic life carry an intensity that can feel overwhelming. You do not create casually or love lightly. At your best you produce creative work of profound psychological depth.", Sagittarius: "Sagittarius on your 5th house cusp means creativity, romance, and joy are all tied to freedom, adventure, and the feeling of expansion. At your best you bring an infectious joy and philosophical depth to everything you create.", Capricorn: "Capricorn on your 5th house cusp means your approach to creativity and romance is serious, disciplined, and oriented toward what will last. At your best the discipline you bring to creative work produces a legacy.", Aquarius: "Aquarius on your 5th house cusp means your creativity and romantic life are unconventional, experimental, and oriented toward the future. At your best you produce creative work that is genuinely ahead of its time.", Pisces: "Pisces on your 5th house cusp means your creativity and romantic life are characterized by deep imagination and an almost oceanic capacity for feeling. At your best you create work of extraordinary spiritual and emotional resonance." },
                6: { Aries: "Aries on your 6th house cusp means your daily work and health are energized by independence, competition, and the drive to act. You work best when you can move fast and make your own decisions. At your best you bring a catalyzing energy to your daily life that gets things done faster than anyone expected.", Taurus: "Taurus on your 6th house cusp means your daily routines and work habits are characterized by steadiness, quality, and a need for physical comfort. Your health is maintained through pleasure and sensory care. At your best your daily life is a model of sustainable, pleasurable productivity.", Gemini: "Gemini on your 6th house cusp means your daily work and health are tied to mental stimulation, variety, and communication. You cannot thrive in repetitive environments. At your best your daily life is intellectually rich and socially connected.", Cancer: "Cancer on your 6th house cusp means your daily work and health are deeply tied to your emotional state. You work best in environments that feel nurturing and familiar. At your best you bring a genuine care and emotional intelligence to your daily work.", Leo: "Leo on your 6th house cusp means your daily work needs to feel meaningful, recognized, and worthy of your talents. Your health thrives when you feel seen. At your best you bring a warmth and generosity to your daily work that elevates everyone around you.", Virgo: "Virgo on your 6th house cusp is the natural ruler in its home — this amplifies everything connected to work, health, and daily routine. You have an extraordinary capacity for detailed, precise, service-oriented work. At your best you are the most reliable and technically skilled person in any working environment.", Libra: "Libra on your 6th house cusp means your daily work and health are tied to harmony, collaboration, and beauty in the working environment. You work best in partnership. At your best you create working environments of genuine cooperation.", Scorpio: "Scorpio on your 6th house cusp means your daily work and health carry an intensity and psychological depth that set you apart. You need to feel that what you are doing matters deeply. At your best you bring a transformative, penetrating focus to your daily work.", Sagittarius: "Sagittarius on your 6th house cusp means your daily work and health thrive when there is meaning, freedom, and a sense of expansion in what you do. At your best your work is an expression of your philosophy and your daily life feels genuinely purposeful.", Capricorn: "Capricorn on your 6th house cusp means your daily work and health are characterized by discipline, structure, and a high standard of quality. At your best the discipline and reliability you bring to your daily work produces something of lasting value.", Aquarius: "Aquarius on your 6th house cusp means your daily work and health thrive in unconventional, innovative environments. At your best you bring a genuinely original and progressive energy to your daily work.", Pisces: "Pisces on your 6th house cusp means your daily work and health are deeply sensitive to the emotional and spiritual atmosphere of your environment. At your best you bring a deep compassion and creative sensitivity to your work." },
                7: { Aries: "Aries on your 7th house cusp means you attract partners who are bold, independent, and direct — people who match your energy or challenge it. At your best your partnerships are alive, energized, and built on genuine mutual respect between two strong people.", Taurus: "Taurus on your 7th house cusp means you attract partners who are stable, sensual, and reliable — people who make you feel grounded and genuinely safe. At your best your partnerships are characterized by a deep, enduring loyalty.", Gemini: "Gemini on your 7th house cusp means you attract partners who are intellectually stimulating, communicative, and versatile. You need your partnerships to feed your mind. At your best your partnerships are characterized by a genuine meeting of minds.", Cancer: "Cancer on your 7th house cusp means you attract partners who are nurturing, emotionally available, and family-oriented. At your best your partnerships are characterized by genuine emotional safety and a mutual devotion that feels like coming home.", Leo: "Leo on your 7th house cusp means you attract partners who are confident, generous, and naturally magnetic. You need your partnerships to feel special. At your best your partnerships are characterized by genuine mutual celebration.", Virgo: "Virgo on your 7th house cusp means you attract partners who are thoughtful, competent, and attentive to detail. You need your partnerships to function well. At your best your partnerships are characterized by a genuine devotion expressed through the thousand small acts of care.", Libra: "Libra on your 7th house cusp is the natural ruler in its home — you are built for relationship, for genuine collaboration, for the kind of connection that makes both people more than they were alone. At your best your partnerships are characterized by a genuine beauty, balance, and reciprocity.", Scorpio: "Scorpio on your 7th house cusp means you attract partners of extraordinary intensity, depth, and psychological complexity. Your partnerships tend toward transformation. At your best your partnerships are characterized by a depth of intimacy and mutual transformation that most people never experience.", Sagittarius: "Sagittarius on your 7th house cusp means you attract partners who are adventurous, philosophical, and freedom-loving. Your partnerships need to feel like they are going somewhere. At your best your partnerships are characterized by a genuine sense of shared adventure.", Capricorn: "Capricorn on your 7th house cusp means you attract partners who are ambitious, reliable, and serious. You need your partnerships to be built on solid ground. At your best your partnerships are characterized by a profound loyalty and a shared commitment to building something that lasts.", Aquarius: "Aquarius on your 7th house cusp means you attract partners who are original, intellectually independent, and committed to something larger. Your partnerships need to allow genuine individual freedom. At your best your partnerships are characterized by a genuine meeting of original minds.", Pisces: "Pisces on your 7th house cusp means you attract partners who are sensitive, imaginative, and spiritually oriented. At your best your partnerships are characterized by a profound spiritual and emotional resonance." },
                8: { Aries: "Aries on your 8th house cusp means you approach transformation, shared resources, and the deep mysteries of life with boldness and directness. You do not shy away from what is difficult or taboo. At your best you face the hardest experiences of life with a courage that produces genuine transformation.", Taurus: "Taurus on your 8th house cusp means transformation comes slowly for you — you resist the deep changes that this house demands until they become unavoidable, and then they are profound and lasting. At your best you build an extraordinary relationship with the enduring dimensions of existence.", Gemini: "Gemini on your 8th house cusp means your experience of transformation is intellectual and communicative — you process the deepest experiences of your life by finding the language for them. At your best you can articulate the experience of transformation in ways that help others through their own.", Cancer: "Cancer on your 8th house cusp means your deepest transformations happen through the emotional body — through grief, through intimacy, through the dissolution of the protective shell around your heart. At your best you approach the deep mysteries of life with a tenderness and intuitive wisdom that genuinely heals.", Leo: "Leo on your 8th house cusp means your deepest transformations involve your relationship to ego, recognition, and creative power. At your best your experience of transformation produces a genuine creative and spiritual authority.", Virgo: "Virgo on your 8th house cusp means you approach transformation and the deep dimensions of life with precision and analysis. At your best you bring a rigorous intelligence to the healing process that produces genuinely lasting change.", Libra: "Libra on your 8th house cusp means your deepest transformations happen through partnership — through the intimacy, loss, and power dynamics that close relationships bring up. At your best your partnerships become genuine vehicles for mutual transformation.", Scorpio: "Scorpio on your 8th house cusp is the natural ruler in its home — this amplifies everything connected to transformation, shared power, and the hidden dimensions of life. You have an extraordinary relationship with the deep mysteries. At your best you are one of the most genuinely transformative presences in anyone's life.", Sagittarius: "Sagittarius on your 8th house cusp means your deepest transformations are philosophical — the experiences that change you most fundamentally transform your beliefs about meaning and the nature of existence. At your best your experience of transformation expands rather than contracts your sense of what is possible.", Capricorn: "Capricorn on your 8th house cusp means your approach to transformation and the deep dimensions of life is structured and disciplined. At your best the discipline you bring to the deepest experiences of your life produces a wisdom and authority that nothing else could.", Aquarius: "Aquarius on your 8th house cusp means your deepest transformations are connected to your sense of collective belonging. At your best your experience of transformation produces an original and forward-looking wisdom.", Pisces: "Pisces on your 8th house cusp means your deepest transformations are spiritual and connected to the dissolution of ego boundaries. At your best your experience of transformation produces a spiritual depth and compassion that is genuinely rare." },
                9: { Aries: "Aries on your 9th house cusp means you approach philosophy, higher learning, and travel with boldness and a pioneering spirit. You form your own worldview through direct experience. At your best your philosophical courage opens territory that others are afraid to enter.", Taurus: "Taurus on your 9th house cusp means your philosophy and worldview are grounded in what you can experience directly through the senses. Your sense of meaning is tied to the physical world and to the beauty of existence. At your best your worldview produces a wisdom that is both practical and profound.", Gemini: "Gemini on your 9th house cusp means your philosophical life is characterized by curiosity, breadth, and a genuine delight in the diversity of ideas. At your best your philosophical life is a genuine adventure of ideas that keeps expanding toward the horizon.", Cancer: "Cancer on your 9th house cusp means your philosophy and worldview are deeply tied to your emotional experience and your sense of belonging. You find meaning through family, heritage, and the wisdom of your ancestors. At your best your philosophical life produces a wisdom that is deeply humane.", Leo: "Leo on your 9th house cusp means your philosophical life is characterized by a generous, dramatic, and genuinely inspiring quality. You believe in big things — in the power of the individual and in creative expression as a spiritual act. At your best your beliefs inspire others.", Virgo: "Virgo on your 9th house cusp means your approach to philosophy and belief is precise, critical, and oriented toward practical application. You do not hold beliefs that you cannot defend rigorously. At your best your philosophical life produces a worldview of extraordinary precision and genuine usefulness.", Libra: "Libra on your 9th house cusp means your philosophy and worldview are organized around justice, beauty, and the pursuit of genuine fairness. At your best your philosophical life produces a wisdom about fairness and relationship that you carry into every dimension of your existence.", Scorpio: "Scorpio on your 9th house cusp means your philosophy and worldview are forged in the deepest experiences of transformation and the encounter with what cannot be controlled. At your best your philosophical life produces a wisdom about transformation and meaning that very few can access.", Sagittarius: "Sagittarius on your 9th house cusp is the natural ruler in its home — this amplifies everything connected to belief, meaning, travel, and the philosophical life. You are genuinely oriented toward the infinite. At your best your philosophical life is a model of how genuine belief in the goodness of existence produces a life of extraordinary richness.", Capricorn: "Capricorn on your 9th house cusp means your philosophical life is characterized by discipline, realism, and a respect for tradition. At your best your philosophical life produces a wisdom of extraordinary depth and practical authority.", Aquarius: "Aquarius on your 9th house cusp means your philosophy and worldview are oriented toward the future and collective progress. At your best your philosophical life is a genuine contribution to the collective conversation about where we go from here.", Pisces: "Pisces on your 9th house cusp means your philosophy and worldview are spiritual and oriented toward the invisible dimensions of existence. At your best your worldview is a genuine encounter with the sacred that produces a compassion and depth of understanding that is genuinely rare." },
                10: { Aries: "Aries on your 10th house cusp means your public life and career are characterized by leadership, initiative, and the willingness to go first. Your reputation is built on courage and directness. At your best you become known as someone who initiated something genuinely new.", Taurus: "Taurus on your 10th house cusp means your public life and career are characterized by steadiness, quality, and a long-term orientation. Your reputation is built on reliability and excellence. At your best you become known for work of extraordinary quality and enduring value.", Gemini: "Gemini on your 10th house cusp means your public life and career are characterized by versatility, communication, and intellectual range. Your reputation is built on your ability to communicate, adapt, and connect. At your best you become known as one of the most versatile and intellectually alive people in your field.", Cancer: "Cancer on your 10th house cusp means your public life and career are deeply influenced by your emotional world. Your reputation is built on your genuine care for the people you work with and serve. At your best you become known for a quality of genuine care and human warmth.", Leo: "Leo on your 10th house cusp means your public life and career are characterized by visibility, creativity, and a natural capacity for leadership. You are meant to be seen in your professional life. At your best you become genuinely known for something that bears your unmistakable creative signature.", Virgo: "Virgo on your 10th house cusp means your public life and career are characterized by precision, skill, and a genuine orientation toward service and improvement. Your reputation is built on reliability and a standard of quality that consistently exceeds what others deliver. At your best you become known as the person who does the work most carefully and most thoroughly.", Libra: "Libra on your 10th house cusp means your public life and career are characterized by diplomacy, aesthetic intelligence, and a natural capacity for collaboration. Your reputation is built on your fairness and your ability to create genuine harmony. At your best you become known for work that is both beautiful and genuinely fair.", Scorpio: "Scorpio on your 10th house cusp means your public life and career are characterized by intensity, strategic intelligence, and a willingness to engage with the territory that others avoid. At your best you become known for work that goes further into the truth than anyone else was willing to go.", Sagittarius: "Sagittarius on your 10th house cusp means your public life and career are characterized by philosophical breadth and a genuine orientation toward meaning. Your reputation is built on your vision and your ability to inspire others. At your best you become known for work that genuinely expands people's understanding of what is possible.", Capricorn: "Capricorn on your 10th house cusp is the natural ruler in its home — this amplifies everything connected to career, public reputation, and legacy. Your reputation is built on your discipline, your integrity, and the quality of what you have built over time. At your best you become genuinely known for work of lasting importance.", Aquarius: "Aquarius on your 10th house cusp means your public life and career are characterized by originality, innovation, and a genuine commitment to collective progress. At your best you become known for work that genuinely changed the conversation.", Pisces: "Pisces on your 10th house cusp means your public life and career are characterized by creative imagination, spiritual sensitivity, and a quality of compassion. At your best you become known for work of extraordinary depth and spiritual resonance." },
                11: { Aries: "Aries on your 11th house cusp means your relationship to community and friendship is characterized by independence and leadership. You do not join groups passively — you either lead them or leave. At your best you inspire communities toward bold action and genuine change.", Taurus: "Taurus on your 11th house cusp means your friendships and community connections are characterized by loyalty, steadiness, and a long-term orientation. At your best you are the most reliable and sustaining presence in any community you belong to.", Gemini: "Gemini on your 11th house cusp means your social world is wide, varied, and constantly expanding. At your best you are a connector — someone who brings people together across different worlds.", Cancer: "Cancer on your 11th house cusp means your friendships and community connections feel like family. At your best you create communities of genuine emotional warmth and mutual care that become something people rely on.", Leo: "Leo on your 11th house cusp means your relationship to community is generous, warm, and characterized by natural leadership. At your best you are the generative heart of any community — the person whose presence makes everything feel more alive.", Virgo: "Virgo on your 11th house cusp means your relationship to community is practical, service-oriented, and characterized by a genuine desire to be useful. At your best you make every community you belong to function better.", Libra: "Libra on your 11th house cusp means your friendships and community connections are characterized by diplomacy, fairness, and a genuine gift for creating harmony. At your best you are a genuine force for fairness and beauty in any community you inhabit.", Scorpio: "Scorpio on your 11th house cusp means your friendships and community connections are few, deep, and intensely loyal. At your best your communities are characterized by an extraordinary depth of loyalty and a shared commitment to what is genuinely true.", Sagittarius: "Sagittarius on your 11th house cusp means your social world is expansive and organized around shared philosophical or ideological values. At your best you create communities of extraordinary vitality and philosophical depth.", Capricorn: "Capricorn on your 11th house cusp means your relationship to community is serious, structured, and oriented toward long-term collective goals. At your best you are the person who takes the long view in any community and ensures that what is built actually lasts.", Aquarius: "Aquarius on your 11th house cusp is the natural ruler in its home — this amplifies everything connected to community, friendship, and collective ideals. At your best you are a genuine visionary of collective life — someone who sees what community could be and helps build it.", Pisces: "Pisces on your 11th house cusp means your relationship to community is characterized by compassion, spiritual sensitivity, and a genuine desire to be part of something that transcends individual interests. At your best you bring a quality of genuine spiritual presence to any community that makes everyone feel less alone." },
                12: { Aries: "Aries on your 12th house cusp means your hidden drives carry a buried assertiveness you may not fully recognize as your own. At your best the energy of this placement fuels a private spiritual practice of extraordinary vitality.", Taurus: "Taurus on your 12th house cusp means your relationship to material security and pleasure has a hidden, complex dimension. At your best this placement gives you access to a deep, private wellspring of creative and sensory wisdom.", Gemini: "Gemini on your 12th house cusp means your unconscious life is characterized by an extraordinary mental activity that operates largely below awareness. At your best this placement gives you access to a visionary intelligence that operates beyond the rational mind.", Cancer: "Cancer on your 12th house cusp means your emotional life has a hidden, mysterious dimension that even you may not fully understand. At your best this placement gives you an extraordinary depth of emotional wisdom and a private spiritual life of genuine nourishment.", Leo: "Leo on your 12th house cusp means your creative and expressive drives have a hidden dimension — a private world of creative imagination that you rarely show to others. At your best this placement gives you access to a private creative life of extraordinary richness.", Virgo: "Virgo on your 12th house cusp means your analytical mind operates partly in the unconscious — your best insights often arrive fully formed rather than through deliberate analysis. At your best this placement gives you an almost psychic precision in perceiving what is needed.", Libra: "Libra on your 12th house cusp means your relationship to partnership and fairness has a hidden, complex dimension. At your best this placement gives you access to a spiritual understanding of love and beauty that informs everything you do.", Scorpio: "Scorpio on your 12th house cusp means your unconscious life is characterized by an extraordinary depth and intensity that operates largely below the surface. At your best this placement gives you access to a genuine mystical depth and transformative spiritual capacity.", Sagittarius: "Sagittarius on your 12th house cusp means your philosophical beliefs and relationship to meaning operate partly in the unconscious. At your best this placement gives you access to a private faith of extraordinary power — a direct relationship to the infinite that sustains you.", Capricorn: "Capricorn on your 12th house cusp means your relationship to authority and ambition has a hidden dimension — fears of failure that operate below the surface. At your best this placement gives you access to a private discipline and spiritual authority of extraordinary depth.", Aquarius: "Aquarius on your 12th house cusp means your relationship to community and originality has a hidden dimension — you may feel secretly alienated from the groups you appear to belong to. At your best this placement gives you access to a private visionary intelligence.", Pisces: "Pisces on your 12th house cusp is the natural ruler in its home — this amplifies everything connected to the unconscious, the spiritual life, and the dissolution of ego boundaries. At your best you have access to a depth of spiritual wisdom and compassionate understanding that is genuinely rare." },
              };

// ── DROP-IN: planetInHouse lookup object ─────────────────────────────────────
// Place this at module level in App.jsx, right after houseDescriptions.
// Usage: planetInHouse[planet.name]?.[planet.house]
// Keys: planet name (string), house number (integer 1-12)

const planetInHouse = {

  Sun: {
    1: "The Sun in your 1st house means your identity and your physical presence are one and the same. You were built to be seen — not in a performative way, but in the sense that your sense of self requires expression outward into the world. You are at your best when you are fully, visibly yourself. The challenge is that your ego is close to the surface, which means criticism lands personally and setbacks can feel like attacks on who you are rather than just what you did. At your best you radiate a warmth and authority that makes others feel both inspired and genuinely welcomed.",
    2: "The Sun in your 2nd house means your sense of self is deeply tied to what you build, what you own, and what you value. You feel most yourself when you are financially stable and surrounded by things of genuine quality. Your identity is expressed through what you create and accumulate — not from greed, but because the material world is where you feel your existence confirmed. The challenge is that your self-worth can become too dependent on external security. At your best you build a life of lasting beauty and substance that expresses exactly who you are.",
    3: "The Sun in your 3rd house means your identity is expressed through your mind and your words. You feel most alive in conversation, in learning, in the exchange of ideas. Your intellect is not separate from who you are — it is the primary vehicle through which you experience yourself as real and significant. The challenge is a tendency to define yourself through what you know rather than who you are beneath the knowing. At your best you are one of the most intellectually alive and communicatively gifted people in any environment.",
    4: "The Sun in your 4th house means your identity is rooted in your private world — in family, in home, and in the deep interior of your emotional life. You shine most fully in private rather than public settings. Your relationship to your roots, your family of origin, and your sense of belonging shapes everything about who you are. The challenge is a difficulty separating your own identity from the family patterns you inherited. At your best you create a home and a private life of extraordinary depth and warmth that becomes the foundation for everything else.",
    5: "The Sun in your 5th house means your identity is expressed through creativity, joy, and the full, dramatic expression of who you are. You were made to create — to play, to love, to perform in the broadest sense of the word. You feel most yourself when you are doing something that bears your unmistakable personal signature. The challenge is a need for recognition that can become a need for constant validation. At your best you bring a genuine creative vitality to everything you touch that makes the world feel more alive.",
    6: "The Sun in your 6th house means your identity is expressed through your work, your craft, and your capacity for genuine service. You feel most yourself when you are being useful — when you are doing something well that matters to someone. Your daily routines and your health are more central to your sense of self than most people realize. The challenge is a tendency to define yourself entirely through your productivity, which makes rest feel like failure. At your best you are one of the most reliable and genuinely skilled people in any working environment.",
    7: "The Sun in your 7th house means your identity is significantly shaped through your relationships with others. You come into yourself most fully through partnership — through the mirror of another person who sees you clearly and reflects something essential back. You may find that you are different people in different relationships, not from inauthenticity but because relationship is genuinely where your self emerges. The challenge is a tendency to lose yourself in others. At your best your partnerships bring out a quality in you that you cannot access alone.",
    8: "The Sun in your 8th house means your identity is forged in the deepest, most transformative experiences life offers. You are drawn to intensity, to the hidden, to the psychological and the taboo — not for shock value but because the surface of things has never been where you actually live. Your sense of self is built through crisis, loss, and radical transformation. The challenge is a difficulty with the ordinary dimensions of existence that do not offer this depth. At your best you have an authority and a psychological power that very few people can access.",
    9: "The Sun in your 9th house means your identity is expressed through your beliefs, your philosophy, and your relationship to meaning. You feel most yourself when you are learning, traveling, teaching, or reaching toward something larger than your immediate circumstances. Your worldview is not separate from who you are — it is the primary lens through which you experience yourself as alive and significant. The challenge is a tendency toward self-righteousness or difficulty with people whose beliefs differ from your own. At your best you inspire others toward a larger and more meaningful engagement with existence.",
    10: "The Sun in your 10th house means your identity is expressed through your public life, your career, and your legacy. You were built for visibility — for a life that is known beyond your immediate circle. Your sense of self is genuinely tied to your professional achievements and your reputation in the world. The challenge is that the gap between your public persona and your private self can become difficult to bridge. At your best you build something of lasting public significance that genuinely expresses who you are.",
    11: "The Sun in your 11th house means your identity is expressed through community, friendship, and your contribution to something larger than yourself. You feel most yourself when you are part of a group that shares your values and is working toward a common vision. Your sense of significance is tied to collective belonging rather than individual achievement. The challenge is a difficulty standing alone when the group moves in a direction that conflicts with your own truth. At your best you inspire communities toward their highest possibility.",
    12: "The Sun in your 12th house means your identity operates largely beneath the surface — in the hidden, the spiritual, and the invisible dimensions of existence. You may feel that your truest self is one that most people never fully see. Solitude is not just a preference but a genuine need — it is where you most fully encounter yourself. The challenge is a difficulty with consistent self-expression in the outer world. At your best you have access to a depth of inner life and spiritual wisdom that most people never develop.",
  },

  Moon: {
    1: "The Moon in your 1st house means your emotional world is immediately visible to others whether you intend it or not. Your face, your body, and your entire physical presence shift with your inner state in ways that people around you can read before you have said a word. You are deeply intuitive and your first impressions of people and situations are almost always accurate. The challenge is emotional vulnerability in public — moods that belong in private sometimes surface in contexts that require more composure. At your best you bring a genuine warmth and emotional presence that makes others feel immediately safe.",
    2: "The Moon in your 2nd house means your emotional security is deeply tied to material stability. When your finances are in order, you feel emotionally settled — when they are not, everything feels uncertain. You may find that you eat, spend, or accumulate in response to emotional states rather than practical needs. Your relationship to your body and to physical comfort is a primary way you regulate your inner world. At your best you build a material life of genuine beauty and security that genuinely nourishes your emotional wellbeing.",
    3: "The Moon in your 3rd house means your emotions and your mind are deeply intertwined. You process feelings through conversation and writing — talking about what you feel is how it becomes real for you. Your early home environment shaped your thinking profoundly, and your communication is colored by emotional memory in ways you may not always recognize. You have an instinctive gift for understanding how others feel and expressing that understanding in words. At your best you are one of the most emotionally intelligent communicators anyone will encounter.",
    4: "The Moon in your 4th house is the Moon in one of its natural homes — this intensifies your connection to family, roots, and the private interior of your life. Your emotional world is deeply shaped by your family of origin, for better or for worse. Home is not just a place but the center of your psychological universe. You carry your history with you everywhere. The challenge is difficulty separating your own emotional needs from the patterns absorbed in childhood. At your best you create a home of extraordinary emotional depth and safety that genuinely heals.",
    5: "The Moon in your 5th house means your emotional world is expressed most naturally through creativity, play, and romantic connection. You feel emotionally alive when you are creating, performing, or in the early stages of love. Your moods have a dramatic, expressive quality — you feel things with your whole self and rarely keep it hidden. Children may be a significant emotional theme. The challenge is emotional dependency on external forms of validation and excitement. At your best your creative and romantic life is a genuine expression of your emotional depth.",
    6: "The Moon in your 6th house means your emotional wellbeing is directly tied to the quality of your daily routines, your work, and your health. When your daily life is in order, your emotional state is stable. When it is chaotic or purposeless, your body and your mood both suffer. You may be prone to anxiety that expresses itself physically. You care deeply about being useful and feel emotionally depleted in environments where your contribution is not needed or recognized. At your best your daily work is a genuine source of emotional nourishment.",
    7: "The Moon in your 7th house means your emotional world is significantly shaped by your close relationships. You feel most emotionally alive and secure within partnerships — and most destabilized when your closest relationships are troubled. You have a deep instinct for what other people need emotionally, which makes you an extraordinarily attentive partner. The challenge is emotional dependency — a tendency to need a partner to feel complete. At your best your relationships are characterized by a genuine emotional intimacy and mutual care that is rare.",
    8: "The Moon in your 8th house means your emotional life operates in the deep places — in the territory of grief, longing, transformation, and the experiences that cannot be spoken about in polite company. You feel things at a depth that most people never access, which makes you both extraordinarily empathetic and occasionally overwhelmed by the intensity of your own inner world. Emotional experiences do not just visit you — they move in. The challenge is learning to release what needs to end. At your best you have an emotional wisdom and resilience forged in genuinely difficult territory.",
    9: "The Moon in your 9th house means your emotional security is tied to your sense of meaning, freedom, and philosophical orientation. You feel most settled when you believe in something larger than your immediate circumstances. Travel, learning, and exposure to different cultures are genuine emotional needs rather than mere preferences. The challenge is emotional restlessness — a sense that where you are is never quite enough and that the feeling you are looking for is always somewhere else. At your best your emotional life is rich with meaning and genuine faith.",
    10: "The Moon in your 10th house means your emotional world is significantly shaped by your public life and professional reputation. You may be unusually visible emotionally in your career — your feelings are part of your professional presence. Your relationship to your mother or a significant parental figure is deeply connected to your sense of public identity. The challenge is a difficulty separating your emotional state from your professional performance. At your best you bring a genuine emotional intelligence and human warmth to your public role that makes your work uniquely impactful.",
    11: "The Moon in your 11th house means your emotional security is tied to your sense of belonging within a community or group. You feel most settled when you are part of something larger — a circle of friends, a cause, a community that shares your values. Your emotional life is shaped significantly by your friendships. The challenge is emotional dependence on group approval. At your best you create genuine emotional belonging wherever you go and become the emotional center of the communities you inhabit.",
    12: "The Moon in your 12th house means your emotional life operates largely beneath the surface — in the unconscious, in dreams, and in the private interior that most people never see. You feel things deeply but often struggle to access or express those feelings directly. Your most significant emotional processing happens in solitude and sleep. You are extraordinarily sensitive to emotional undercurrents in your environment. At your best you have a compassionate depth and spiritual sensitivity that makes you genuinely healing to be around.",
  },

  Mercury: {
    1: "Mercury in your 1st house means your mind and your physical presence are inseparable. You come across as quick, articulate, and intellectually alert — people sense immediately that your mind is running. You speak before you have finished thinking, which makes you refreshingly direct and occasionally surprising to yourself. Your ideas are a primary part of your identity. The challenge is a restlessness that can make stillness feel intolerable. At your best you are one of the most mentally alive and communicatively compelling people in any room.",
    2: "Mercury in your 2nd house means your mind is oriented toward practical value — toward what ideas are worth and what they can build. You think about money, resources, and material security more carefully than most. You may earn through your communication skills, your intelligence, or your ability to assess and articulate value. The challenge is a tendency to measure the worth of ideas by their material utility alone. At your best you have an extraordinary capacity to translate intelligence into tangible, lasting value.",
    3: "Mercury in your 3rd house is the planet in one of its natural homes — this amplifies everything about how you think and communicate. Your mind is quick, curious, and perpetually seeking new information and connection. You are at your best in conversation, in writing, in the constant exchange of ideas. The challenge is a difficulty going deep into any single thing when the breadth of what is interesting is so vast. At your best you are one of the most naturally gifted communicators and thinkers in your environment.",
    4: "Mercury in your 4th house means your mind is rooted in memory, family, and the deep interior of your private life. You think through the past — your childhood, your family patterns, your emotional history — with an unusual clarity and intelligence. Your home is likely where you do your best thinking. The challenge is a mind that can become too focused on what has already happened rather than what is possible. At your best you bring an extraordinary psychological intelligence to understanding how the past shapes the present.",
    5: "Mercury in your 5th house means your mind is playful, creative, and oriented toward self-expression. You think best when you are enjoying yourself — when ideas feel like play rather than work. You have a natural gift for storytelling, performance, and any form of creative communication. The challenge is a difficulty with the sustained, disciplined intellectual effort that serious projects require. At your best your intelligence produces creative work of unusual originality and genuine delight.",
    6: "Mercury in your 6th house means your mind is oriented toward precision, improvement, and practical usefulness. You think in systems, processes, and the details that make the difference between something working and something working well. Your intellectual gifts express themselves most fully through work — through the careful, methodical application of intelligence to real problems. The challenge is overthinking and a critical faculty that can become exhausting. At your best you are one of the most practically intelligent and analytically precise people in any working environment.",
    7: "Mercury in your 7th house means your mind comes alive through dialogue — through the genuine exchange with another person who thinks differently than you do. You process your ideas through conversation and your best thinking happens in relationship. You have a natural gift for understanding other perspectives and for finding the language that bridges different positions. The challenge is difficulty thinking independently of other people's responses. At your best you are one of the most skillful intellectual collaborators and mediators anyone will encounter.",
    8: "Mercury in your 8th house means your mind goes to the deep places naturally. You think about power, psychology, sex, death, and the hidden dimensions of human experience — not morbidly but because the surface of things has never been where the truth actually lives. You are a natural researcher, investigator, and psychological analyst. The challenge is a mind that can become obsessive or suspicious. At your best you bring a penetrating intelligence to the places most people are afraid to look.",
    9: "Mercury in your 9th house means your mind is oriented toward the big picture — toward philosophy, meaning, and the questions that cannot be answered in a single conversation. You think in frameworks, in worldviews, in the largest possible context. You are drawn to higher learning, to travel, to any experience that expands your understanding of what is possible. The challenge is impatience with detail and a difficulty staying in the smaller, more precise dimensions of any problem. At your best you are one of the most inspiring and philosophically generous thinkers in any community.",
    10: "Mercury in your 10th house means your intelligence and communication skills are central to your public identity and your career. You are known for how you think and how you speak. Your professional reputation is built in significant part on your intellectual gifts. You may be drawn to careers in writing, teaching, law, journalism, or any field where ideas and communication are the primary currency. The challenge is a tendency to intellectualize your public life at the expense of genuine emotional presence. At your best your mind is your most powerful professional asset.",
    11: "Mercury in your 11th house means your mind comes alive in community — in the exchange of ideas within groups, communities, and networks of people who share your intellectual interests. Your friendships are primarily intellectual connections. You are drawn to innovative, forward-thinking communities where the conventional assumptions are being questioned. The challenge is a tendency to value collective thinking over individual intellectual development. At your best you are one of the most catalyzing intellectual presences in any community you inhabit.",
    12: "Mercury in your 12th house means your mind operates significantly in the unconscious — your best insights arrive from beneath the surface of rational thought, often in dreams, in meditation, or in the quiet spaces between deliberate thinking. You may struggle to articulate what you know or find that the gap between what you perceive and what you can express is frustratingly large. The challenge is a mind that can become lost in confusion or fantasy. At your best you have access to an intuitive and visionary intelligence that purely rational minds cannot reach.",
  },

  Venus: {
    1: "Venus in your 1st house means beauty, charm, and a natural magnetism are built into how you present yourself to the world. You make a genuinely attractive first impression — not just physically but in terms of warmth, grace, and a quality of ease that puts people immediately at their comfort. Your appearance matters to you and you attend to it with a natural aesthetic intelligence. The challenge is a tendency to value being liked over being truthful. At your best you bring a genuine beauty and warmth to every environment you enter that makes people feel more alive.",
    2: "Venus in your 2nd house means your relationship to beauty, pleasure, and material comfort is one of the most significant dimensions of your life. You have an extraordinary eye for quality and value — in objects, in people, in opportunities. Money flows toward you with relative ease because you genuinely appreciate and care for what you have. The challenge is a tendency toward overindulgence or attachment to the material security that beauty provides. At your best you build a life of extraordinary sensory and aesthetic richness that is genuinely yours.",
    3: "Venus in your 3rd house means you communicate with an elegance and warmth that makes people want to stay in conversation with you. Your mind finds beauty in language, in ideas, in the connections between things. You are naturally charming in social and intellectual contexts and may have a particular gift for writing. The challenge is a tendency to prioritize pleasant communication over honest communication. At your best your words carry both beauty and genuine truth — a rare combination.",
    4: "Venus in your 4th house means your home is your sanctuary of beauty and your deepest source of emotional nourishment. You invest significantly in creating a private environment of genuine aesthetic beauty and warmth. Your family relationships, particularly with a parent, carry a quality of Venus — love, beauty, and sometimes the complications of conditional affection. The challenge is difficulty bringing the harmony of your private world into the messier dimensions of public life. At your best your home becomes a place of extraordinary beauty and genuine healing for everyone who enters.",
    5: "Venus in your 5th house means creativity, romance, and pleasure are among the most important dimensions of your life. You love with a genuine dramatic warmth and your creative gifts — whatever form they take — are infused with a beauty and sensory richness that is distinctly your own. You are drawn to beautiful people, beautiful art, and beautiful experiences of all kinds. The challenge is a tendency to pursue pleasure and romance at the expense of depth and commitment. At your best your creative and romantic life produces something of extraordinary beauty and genuine feeling.",
    6: "Venus in your 6th house means you bring a quality of beauty, care, and genuine aesthetic attention to your daily work and routines. You work best in environments that feel harmonious and visually considered — ugliness and conflict in the workplace genuinely affect your productivity and wellbeing. Your health benefits from pleasure, beauty, and the sensory dimension of daily care. The challenge is difficulty with the unglamorous aspects of any job. At your best you transform your daily work environment through a quality of genuine care and beauty that makes everyone around you function better.",
    7: "Venus in your 7th house is the planet in one of its natural homes — this amplifies everything about your capacity for partnership and your orientation toward genuine relationship. You are built for love and collaboration. You attract beautiful, charming, and genuinely warm people into your life. Your partnerships tend to have a quality of real aesthetic and emotional harmony. The challenge is a tendency to idealize partners or maintain harmony at the expense of honesty. At your best your relationships are characterized by a genuine beauty and mutual appreciation that becomes something others look to as a model.",
    8: "Venus in your 8th house means your experience of love and beauty goes to the deepest places — you cannot love lightly, and genuine intimacy involves a kind of transformation that is both extraordinary and occasionally terrifying. Your attractions are intense and your relationships tend toward the profound and the complicated. Money and shared resources are significant themes. The challenge is a tendency toward jealousy, possessiveness, or a power dynamic in love. At your best you experience a depth of love and intimacy that most people never access.",
    9: "Venus in your 9th house means your experience of beauty and love is tied to freedom, meaning, and the expansive dimensions of existence. You are attracted to people from different backgrounds, different cultures, and different philosophical orientations. Love that does not expand your world holds little interest. You find beauty in ideas, in travel, in the encounter with what is foreign and illuminating. The challenge is difficulty committing to any single love or aesthetic when the horizon always offers something new. At your best your love life and your philosophical life are one and the same.",
    10: "Venus in your 10th house means your professional reputation is significantly shaped by your charm, your aesthetic gifts, and your genuine warmth. You are known in your public life for a quality of beauty and grace. Your career may involve art, beauty, diplomacy, or any field where aesthetic intelligence and interpersonal charm are assets. The challenge is a tendency to prioritize being liked professionally over being effective. At your best your public life is characterized by a genuine beauty and social grace that opens doors that talent alone would not.",
    11: "Venus in your 11th house means your friendships are among the most beautiful and significant relationships in your life. You attract warm, genuine, and often artistically or aesthetically oriented people into your social world. Your community connections have a quality of real warmth and mutual appreciation. The challenge is a tendency to prioritize social harmony over genuine connection. At your best you create social worlds of extraordinary warmth and beauty that become genuinely sustaining for everyone in them.",
    12: "Venus in your 12th house means your experience of love and beauty has a hidden, mysterious, and sometimes self-sabotaging dimension. You may experience your most significant love in secret, in fantasy, or in relationships that cannot be fully expressed in the outer world. Your aesthetic sensibility is unusually deep and connected to the invisible dimensions of experience. The challenge is a pattern of loving people who are unavailable or of sacrificing yourself in love. At your best you have access to a spiritual and artistic depth in love that very few people can reach.",
  },

  Mars: {
    1: "Mars in your 1st house means your drive, your assertiveness, and your physical energy are immediately apparent to everyone you encounter. You come across as direct, competitive, and energized — someone who moves toward what they want without much hesitation. Your physical presence carries a charge of Mars energy that people respond to. The challenge is that your anger and your impatience are also immediately visible, which can create conflict in situations that required more restraint. At your best you are one of the most courageous and catalyzing physical presences in any environment.",
    2: "Mars in your 2nd house means your drive is oriented toward building and protecting your material security. You pursue financial goals with significant energy and are willing to fight for what you believe you have earned. You may be impulsive with money — spending and earning with the same intensity. Your self-worth is tied to your capacity to act and to produce results. The challenge is conflict around money and resources, particularly in shared financial contexts. At your best you build financial security through a drive and directness that most people simply cannot sustain.",
    3: "Mars in your 3rd house means your mind is combative, fast, and built for intellectual competition. You speak before you have finished thinking, argue with genuine relish, and pursue ideas with a physical intensity that sets you apart. You learn by doing and debating rather than by reading and reflecting. The challenge is a communication style that can feel aggressive or confrontational to people who are not ready for your directness. At your best you are one of the sharpest and most mentally energized communicators in any room.",
    4: "Mars in your 4th house means your home and family life carry a significant charge of Mars energy — conflict, intensity, and a fierceness around protecting what you love. Your private life is rarely calm. A parent may have carried a strong Mars quality. You may experience significant anger around your family of origin or find that your home environment has been characterized by more conflict than most. The challenge is separating your drive and anger from your most intimate relationships. At your best the fierceness with which you protect your home and family becomes an extraordinary force for genuine safety.",
    5: "Mars in your 5th house means your creative and romantic life are characterized by intense passion, bold expression, and a competitive approach to self-expression. You pursue love and creative projects with the same energy you bring to everything — all in, immediate, and completely committed. Your creative work has a physical vitality and a directness that is unmistakably yours. The challenge is a tendency to burn through romantic connections as fast as you ignite them. At your best your creative and romantic life is characterized by a passionate, life-giving energy that is genuinely contagious.",
    6: "Mars in your 6th house means your work ethic is extraordinary and your approach to daily tasks is energized, disciplined, and driven by a genuine desire to do things well and do them now. You are one of the hardest working people in any environment — but you can also be one of the most demanding, of yourself and others. Your health may be affected by overexertion or by suppressed anger. The challenge is learning to pace yourself and to apply your extraordinary energy without burning out. At your best you produce daily work of remarkable quality and quantity.",
    7: "Mars in your 7th house means your closest relationships carry a significant charge of Mars energy — passion, conflict, competition, and a fierceness that can be either deeply bonding or genuinely destructive depending on how consciously it is worked with. You attract partners who are strong, direct, and occasionally combative. You may project your own assertiveness onto others, attracting conflict you could have owned directly. The challenge is learning to fight for your relationships rather than within them. At your best your partnerships are characterized by a passionate intensity and genuine aliveness.",
    8: "Mars in your 8th house means your drive goes to the deepest places — power, sexuality, transformation, and the territory beneath the surface of things. You pursue what you want with a focused, strategic intensity that is not immediately visible but is essentially unstoppable. You are drawn to crisis situations where the ordinary rules do not apply and your particular form of courage is genuinely needed. The challenge is a tendency toward obsession and a difficulty releasing control. At your best you have an extraordinary capacity for transformation and a courage that operates in the places most people refuse to go.",
    9: "Mars in your 9th house means your drive is oriented toward meaning, freedom, and the pursuit of a philosophy worth living by. You pursue truth with the same energy others pursue money or status. You are drawn to debate, to the confrontation of ideas, and to any experience that expands your understanding of what is real and what is possible. The challenge is a tendency toward self-righteousness — a combativeness around your beliefs. At your best your intellectual courage and philosophical passion inspire others toward a more honest and expansive engagement with existence.",
    10: "Mars in your 10th house means your ambition and your drive are directed primarily toward your public life and your career. You pursue professional goals with an intensity and directness that earns both respect and occasional conflict. Your reputation is built in significant part on your willingness to act, to lead, and to go after what you want without waiting for permission. The challenge is a tendency toward conflict with authority figures and a combativeness in professional settings that can undermine what you are trying to build. At your best you achieve things publicly that most people only imagine.",
    11: "Mars in your 11th house means your drive is oriented toward collective action — toward groups, communities, and causes that are trying to change something. You pursue your social and political ideals with genuine passion and are willing to fight for the people and principles you believe in. Your friendships may have a competitive or combative quality. The challenge is a tendency to create conflict within the groups you are trying to serve. At your best you are one of the most galvanizing and effective advocates for collective change in any community you inhabit.",
    12: "Mars in your 12th house means your drive and anger operate significantly beneath the surface — in the unconscious, in hidden patterns of behavior, and in contexts that do not fit neatly into your ordinary life. You may find that your assertiveness surfaces in ways that surprise even you, or that your anger is expressed indirectly because direct expression feels unsafe. The challenge is a drive that does not know where to go and an anger that has no obvious outlet. At your best you channel the energy of this placement into spiritual practice, creative work, or compassionate service — producing results of extraordinary quiet power.",
  },

  Jupiter: {
    1: "Jupiter in your 1st house means expansion, confidence, and a genuine optimism are built into how you move through the world. You make a big impression — physically, energetically, and in terms of the warmth and abundance you seem to carry with you. Opportunities tend to find you because you move through the world in a way that invites them. The challenge is excess — a tendency toward overconfidence, overextension, or a physical expansiveness that requires monitoring. At your best you are genuinely inspiring — someone who makes the world feel larger and more possible just by being in it.",
    2: "Jupiter in your 2nd house means abundance, generosity, and genuine good fortune in material matters are significant themes in your life. You have a natural gift for attracting resources and for recognizing value before others do. Money tends to come and go on a large scale — you earn generously and spend generously. The challenge is a tendency toward financial overextension and a faith in future abundance that occasionally ignores present reality. At your best you build a material life of genuine abundance and share it with a generosity that enriches everyone around you.",
    3: "Jupiter in your 3rd house means your mind reaches naturally toward the big picture, the philosophical question, and the meaning behind the meaning. You communicate with an enthusiasm and breadth that makes people feel genuinely expanded. Learning and the exchange of ideas are primary sources of joy for you. The challenge is breadth without depth — a tendency to skim the surface of many things rather than going all the way into any of them. At your best you are one of the most intellectually generous and genuinely inspiring communicators in any community.",
    4: "Jupiter in your 4th house means your home, your family, and your sense of rootedness carry a quality of genuine abundance and warmth. Your private life is a source of real nourishment and expansion rather than depletion. A parent may have carried a strong Jupiter quality — a philosophical, generous, or adventurous energy. Your sense of inner security is strong and tends to generate genuine good fortune in other areas of life. The challenge is a tendency toward excess in domestic life. At your best your home becomes a place of extraordinary generosity and philosophical warmth.",
    5: "Jupiter in your 5th house means creativity, romance, and joy are among the most abundantly blessed dimensions of your life. You love grandly, create prolifically, and experience pleasure with a fullness that most people only occasionally access. Your creative gifts are real and significant. Children may be a significant source of joy. The challenge is overextension in love and a tendency to take creative and romantic risks without adequate preparation. At your best you produce creative work of extraordinary scope and generosity and love with a warmth that transforms the people you are with.",
    6: "Jupiter in your 6th house means your work, your health, and your daily routines are characterized by a genuine abundance and expansive orientation. You give generously in your work and attract opportunities through your willingness to go beyond what is strictly required. Your health benefits from optimism and movement. The challenge is a tendency to take on more work than you can sustainably manage. At your best your daily work is characterized by a genuine generosity and philosophical breadth that makes you one of the most valued people in any working environment.",
    7: "Jupiter in your 7th house means your partnerships are characterized by genuine warmth, expansion, and mutual growth. You attract partners who are generous, philosophical, and expansive — people who make your world larger. Your closest relationships tend to have a quality of real abundance and optimism that sustains both of you. The challenge is a tendency to idealize partners or to attract people whose expansiveness is actually overextension. At your best your partnerships are characterized by a genuine mutual generosity and a shared faith in growth that becomes one of the most sustaining forces in your life.",
    8: "Jupiter in your 8th house means your experience of transformation, shared resources, and the deep mysteries of life carries a quality of expansion and good fortune. You may benefit significantly through inheritance, investment, or other people's resources. Your experience of the deepest and most difficult dimensions of life — loss, crisis, transformation — tends to produce genuine wisdom and eventual expansion rather than just pain. The challenge is a tendency to overextend in shared financial situations. At your best your experience of the deep dimensions of life produces a philosophical generosity that is genuinely rare.",
    9: "Jupiter in your 9th house is the planet in its natural home — this amplifies everything about your philosophical life, your relationship to meaning, and your orientation toward growth and expansion. You have a genuine and deep faith in the goodness of existence that is not naive but structural. Travel, learning, and the pursuit of meaning are not just activities but genuine spiritual practices. The challenge is a tendency toward dogmatism — a belief that you have found the truth and others simply need to catch up. At your best you are one of the most genuinely inspiring and philosophically generous people in any community.",
    10: "Jupiter in your 10th house means your professional life and public reputation are characterized by genuine good fortune, expansion, and a quality of optimism that makes you effective in ways that pure competence alone would not. You attract significant opportunities in your career and your reputation tends to grow steadily over time. The challenge is a tendency to overextend professionally or to take on public commitments you cannot fully deliver. At your best you build a public life and professional legacy of extraordinary scope and genuine positive impact.",
    11: "Jupiter in your 11th house means your social world, your community connections, and your relationship to collective ideals are characterized by genuine abundance and expansive warmth. Your friendships are numerous, significant, and a genuine source of joy. You attract warm, generous, and philosophically expansive people into your community. Your social ideals are real and you are effective at inspiring others toward them. The challenge is a tendency to overcommit socially or to attract people whose expansiveness is actually unreliability. At your best you create communities of extraordinary vitality and genuine collective abundance.",
    12: "Jupiter in your 12th house means your relationship to the spiritual, the unconscious, and the hidden dimensions of existence carries a quality of genuine abundance and philosophical depth. You have a deep and often private faith that sustains you through difficulty in ways that others may not fully understand. Your most significant growth often happens in solitude or in circumstances that remove you from ordinary life. The challenge is a tendency to escape into the spiritual dimensions at the expense of practical engagement. At your best you have access to a philosophical and spiritual wisdom of extraordinary depth that enriches everything you do.",
  },

  Saturn: {
    1: "Saturn in your 1st house means the themes of discipline, responsibility, and the weight of external expectation are written into your very presence. You may have felt from an early age that simply being yourself was not enough — that you had to earn your right to take up space. The result is often a person of unusual seriousness, self-discipline, and genuine authority. The challenge is a relationship with yourself that is permanently conditional — self-worth tied to performance and achievement. At your best you carry an earned authority and a composed gravitas that makes others instinctively trust your judgment.",
    2: "Saturn in your 2nd house means your relationship to money, material security, and self-worth has been shaped by genuine scarcity or by the lesson that nothing of value comes without real effort. You may have experienced significant financial difficulty or grown up in circumstances where material security was uncertain. The result is often a person of extraordinary financial discipline and genuine resourcefulness. The challenge is a scarcity mindset that persists even when the situation has genuinely improved. At your best you build a material life of real solidity and lasting value through discipline and patience that others cannot match.",
    3: "Saturn in your 3rd house means your relationship to your own mind and your capacity to communicate has been shaped by restriction, criticism, or a deep sense of inadequacy. You may have been told early that you were not smart enough, articulate enough, or worthy of being heard. The result is often a person of extraordinary intellectual discipline and genuine depth. The challenge is self-censorship and a critical inner voice that is louder than your authentic intelligence. At your best you develop a precision and authority of thought and expression that takes time to build but proves more lasting than any natural gift.",
    4: "Saturn in your 4th house means your home and family foundation have been characterized by responsibility, restriction, or emotional coolness. A parent — often the father — may have carried a strong Saturn quality: demanding, withholding, or simply absent in the ways that matter most emotionally. The result is often a person who has had to build their own emotional foundation from scratch. The challenge is a private life that feels like work rather than sanctuary. At your best you build a home of extraordinary solidity and genuine emotional security that you created yourself rather than inherited.",
    5: "Saturn in your 5th house means your relationship to creativity, joy, and romantic expression has been shaped by restriction, inhibition, or the early lesson that pleasure is not safe or legitimate. You may take your creative work with a seriousness that borders on inability to play. In romance you are loyal and serious but may struggle with lightness and spontaneity. The challenge is a relationship to joy that is too controlled to actually feel like joy. At your best the discipline and seriousness you bring to creative work produces something of extraordinary quality and lasting significance.",
    6: "Saturn in your 6th house means your relationship to work, health, and daily routine is characterized by discipline, high standards, and an exacting quality that produces excellent results but can also produce burnout and chronic anxiety. You hold yourself and others to a standard that is genuinely high and you do not accept mediocrity in your work or your environment. The challenge is work that becomes a source of anxiety rather than genuine productivity. At your best you are one of the most reliable and genuinely skilled people in any working environment — someone whose standards produce results that last.",
    7: "Saturn in your 7th house means your partnerships have been shaped by the themes of Saturn — delay, restriction, responsibility, and the lesson that genuine relationship requires real work. You may have experienced significant difficulty or delay in finding committed partnership. Your closest relationships carry a quality of serious responsibility and mutual obligation. The challenge is attracting partners who are cold, withholding, or older and more authoritative — people who carry the Saturn projection. At your best your partnerships are built on a foundation of genuine commitment and mutual responsibility that outlasts whatever was merely romantic.",
    8: "Saturn in your 8th house means your experience of transformation, shared resources, and the deep mysteries of life has been shaped by difficulty, restriction, and the lesson that genuine change requires genuine surrender. You may have experienced significant loss, financial difficulty through shared resources, or a complex relationship with power and control. The challenge is a resistance to the surrender that transformation requires. At your best you develop a psychological depth and philosophical authority around the deepest dimensions of human experience that very few people can access.",
    9: "Saturn in your 9th house means your relationship to belief, philosophy, and meaning has been shaped by restriction, disillusionment, or the lesson that faith must be earned through genuine experience rather than simply inherited. You may have grown up in a rigidly religious or ideological environment that you later had to dismantle, or you may have experienced a significant loss of faith that left your philosophical life on uncertain ground. The challenge is a worldview that is too restricted by what can be proven. At your best you develop a philosophy of extraordinary rigor and genuine depth that has been tested by real experience.",
    10: "Saturn in your 10th house is the planet in one of its natural homes — this amplifies everything about your relationship to ambition, public life, and the building of a lasting legacy. You are built for the long game of professional achievement. Your reputation is built through discipline, integrity, and a willingness to do the work even when results are slow in coming. The challenge is a relationship to your career that is too driven by obligation and the fear of failure to feel genuinely satisfying. At your best you build a professional legacy of real significance that outlasts the trends and the noise.",
    11: "Saturn in your 11th house means your relationship to community, friendship, and collective ideals has been shaped by difficulty, isolation, or the lesson that belonging must be earned through genuine contribution. You may have felt like an outsider in groups or experienced significant difficulty finding your true community. Your friendships are few and carefully chosen. The challenge is a social isolation that prevents you from accessing the collective support you need. At your best you build community connections of extraordinary depth and reliability — a small circle of people who genuinely matter to each other.",
    12: "Saturn in your 12th house means your relationship to restriction, limitation, and the weight of the past operates largely in the unconscious. You may carry fears, guilt, or a sense of obligation that you cannot fully trace to their origins. Solitude can feel like punishment rather than rest. The challenge is a self-imposed restriction that operates below the level of awareness and limits your freedom in ways you may not fully recognize. At your best you develop a private discipline and spiritual authority of extraordinary depth — a capacity for solitary inner work that produces genuine wisdom.",
  },

  Uranus: {
    1: "Uranus in your 1st house means originality, rebellion, and a quality of electric unpredictability are built into your very presence. You are impossible to categorize and resistant to any identity that is imposed from outside. You may have felt from an early age that you did not fit the standard model — and you were right. The challenge is a restlessness and inconsistency in self-presentation that makes it difficult for others to know what to expect from you. At your best you are genuinely one of a kind — someone whose presence opens up possibilities that more conventional people cannot even imagine.",
    2: "Uranus in your 2nd house means your relationship to money, resources, and material security is characterized by sudden changes, unconventional approaches, and an instinctive resistance to financial conventionality. Your income may be irregular — feast and famine in unpredictable cycles. You may have genuinely original ideas about value and wealth. The challenge is financial instability born from an unwillingness to accept the conventional structures that create consistent material security. At your best you find genuinely innovative ways to create and sustain material abundance.",
    3: "Uranus in your 3rd house means your mind operates in genuinely original and unconventional ways. You see connections that others miss, think in patterns that most people cannot follow, and communicate in ways that are simultaneously brilliant and occasionally inaccessible. Your ideas tend to arrive ahead of where the conversation is. The challenge is a communication style that can feel erratic or difficult to follow. At your best you are one of the most genuinely original thinkers in any environment — someone whose ideas change the conversation.",
    4: "Uranus in your 4th house means your home and family life have been characterized by disruption, unconventionality, and sudden change. Your family of origin may have been unusual, unstable, or ahead of its time in ways that set you apart from your peers. Your relationship to home and roots is complex — you need both a secure base and the freedom to disrupt it. The challenge is difficulty creating the kind of stable emotional foundation that Uranus energy tends to disrupt. At your best you create a home that is both genuinely free and genuinely sustaining.",
    5: "Uranus in your 5th house means your creative expression, your romantic life, and your approach to joy are characterized by originality, experimentation, and a genuine need for freedom. You create work that breaks existing forms and love people who are genuinely original. Your approach to romance is unconventional — traditional relationship structures tend to feel constraining. The challenge is a difficulty sustaining creative or romantic commitments past the point where they start to feel routine. At your best you produce creative work of genuine originality and form connections of unusual freedom and mutual respect.",
    6: "Uranus in your 6th house means your approach to work, health, and daily routine is characterized by a genuine need for innovation, freedom, and the ability to do things differently. You cannot sustain effort in rigid, hierarchical working environments. Your health responds unusually to conventional treatments and may require unconventional approaches. The challenge is a difficulty with the consistent, repetitive aspects of daily life that Uranus energy tends to disrupt. At your best you bring a genuinely innovative energy to your daily work that transforms how things are done.",
    7: "Uranus in your 7th house means your partnerships are characterized by a need for genuine freedom, originality, and unconventional arrangement. You attract partners who are unusual, independent, and resistant to traditional relationship roles. Your partnerships may begin or end suddenly. The challenge is a pattern of disrupting relationships just as they begin to deepen into genuine commitment. At your best you form partnerships of extraordinary originality and mutual freedom that allow both people to be genuinely themselves.",
    8: "Uranus in your 8th house means your experience of transformation, shared resources, and the deep mysteries of life carries a quality of sudden revelation and radical disruption. Your most significant transformations tend to happen suddenly rather than gradually. Shared finances may involve sudden gains or losses. The challenge is a difficulty with the slow, patient work that genuine psychological transformation requires. At your best you experience breakthroughs in the deepest dimensions of your life that are as sudden as they are profound.",
    9: "Uranus in your 9th house means your philosophical life is characterized by genuine originality, radical departure from received wisdom, and a relationship to truth that is constantly being revised. You cannot hold inherited beliefs — you must arrive at your own worldview through your own experience. Your approach to religion, philosophy, and higher learning is unconventional and occasionally revolutionary. The challenge is a philosophical restlessness that prevents genuine depth. At your best you develop a genuinely original philosophical framework that challenges conventional assumptions in important ways.",
    10: "Uranus in your 10th house means your public life and career are characterized by sudden changes, unconventional approaches, and a genuine need to do things differently. Your professional path rarely follows a conventional trajectory — you may change careers suddenly or find that your most significant professional contributions come from disrupting the established way of doing things. The challenge is professional instability born from an unwillingness to conform to institutional expectations. At your best your public life becomes genuinely innovative — you change the field you work in.",
    11: "Uranus in your 11th house is the planet in one of its natural homes — this amplifies everything about your relationship to community, collective ideals, and the possibility of genuine social transformation. You are genuinely oriented toward the future and your communities tend to be unconventional, forward-thinking, and ahead of their time. The challenge is a tendency to disrupt the communities you are trying to serve. At your best you are one of the most genuinely visionary and catalyzing forces for collective progress in any community you inhabit.",
    12: "Uranus in your 12th house means your most significant experiences of freedom, disruption, and radical originality operate largely in the unconscious and in the hidden dimensions of your inner life. Your most genuinely original insights tend to arrive from beneath the surface of rational awareness. The challenge is a revolutionary energy that has no clear outlet in the outer world. At your best you access a genuinely visionary dimension of unconscious intelligence that informs your life in ways that are powerful precisely because they operate below the ordinary threshold of awareness.",
  },

  Neptune: {
    1: "Neptune in your 1st house means your identity has a fluid, permeable, and somewhat mysterious quality — both to others and to yourself. You are unusually sensitive to the emotional atmosphere around you, absorbing the moods and energies of your environment in ways that can be both a gift and a genuine challenge to your sense of self. Others may find it difficult to fully grasp who you are, which can create a quality of mystique that draws people in. The challenge is a difficulty maintaining a clear and stable sense of your own identity. At your best you have an almost otherworldly quality of empathy and imagination that makes your presence genuinely healing.",
    2: "Neptune in your 2nd house means your relationship to money, material security, and your own values has a fluid, idealistic, and sometimes confused quality. You may have difficulty maintaining consistent financial structures or find that money comes and goes in ways that feel beyond your control. Your values are genuinely spiritual rather than material, which can make practical financial management feel fundamentally at odds with who you are. The challenge is maintaining the practical grounding that material life requires alongside a genuinely non-material orientation. At your best you build a life whose value is measured in dimensions that transcend the financial.",
    3: "Neptune in your 3rd house means your mind is poetic, intuitive, and operating on frequencies that more linear thinkers simply do not access. You think in images, associations, and emotional impressions. Your communication has a quality of depth and resonance that pure logic cannot produce. The challenge is difficulty with precision, clarity, and the concrete specificity that many practical situations require. At your best you communicate with a poetic depth and emotional resonance that touches something true in people that rational language alone cannot reach.",
    4: "Neptune in your 4th house means your home, family, and deepest psychological roots have a quality of mystery, confusion, or spiritual depth. Your family of origin may have been characterized by something hidden, unclear, or idealized in ways that made it difficult to see clearly. Your sense of home is connected to the invisible, the spiritual, and the imaginal. The challenge is a foundation that shifts rather than holds — a difficulty accessing the solid emotional ground that genuine security requires. At your best your private life is a place of extraordinary spiritual depth and creative imagination.",
    5: "Neptune in your 5th house means your creative expression, your romantic life, and your experience of joy carry a quality of spiritual depth, idealism, and transcendent longing. You create work of extraordinary imaginative and emotional depth. In love you seek a connection that transcends the ordinary — a meeting of souls rather than just of personalities. The challenge is a tendency to idealize romantic partners and creative projects past the point of practical reality. At your best your creative work is genuinely inspired and your experience of love touches the sacred.",
    6: "Neptune in your 6th house means your relationship to daily work, health, and routine has a fluid, spiritually oriented, and sometimes confusing quality. You work best when your daily life feels meaningful — when your routine is connected to something larger than mere productivity. Your health is unusually sensitive to the emotional and spiritual atmosphere of your environment. The challenge is a difficulty maintaining the consistent, practical structures that daily functioning requires. At your best your daily work is a genuine spiritual practice — a form of service that connects the ordinary and the transcendent.",
    7: "Neptune in your 7th house means your partnerships carry a quality of spiritual depth, idealism, and the longing for perfect union. You seek a partner who feels like a soulmate — a connection that transcends the ordinary dimensions of relationship. The challenge is a tendency to idealize partners, seeing them as you wish they were rather than as they actually are. Disillusionment in relationships can be significant. At your best your partnerships are characterized by a genuine spiritual resonance and compassionate understanding that most people never experience in love.",
    8: "Neptune in your 8th house means your experience of transformation, shared resources, and the deep mysteries of life carries a quality of spiritual dissolution, compassionate surrender, and genuine mystical depth. Your most significant transformations have a quality of the sacred — of ego dissolution and genuine rebirth. Shared finances may be characterized by confusion or sacrifice. The challenge is a difficulty maintaining clear boundaries around shared resources and power. At your best you have an extraordinary spiritual depth and compassionate wisdom about the deepest dimensions of human experience.",
    9: "Neptune in your 9th house means your philosophical life is characterized by a spiritual depth, a genuine mystical orientation, and a relationship to meaning that transcends ordinary religious or philosophical structures. You seek truth that cannot be fully articulated in words — a direct experience of the sacred rather than a belief system about it. The challenge is a philosophical idealism that can dissolve into confusion when it encounters practical reality. At your best your philosophical life is a genuine encounter with the infinite that produces a wisdom and compassion that are genuinely rare.",
    10: "Neptune in your 10th house means your public life and career carry a quality of idealism, spiritual significance, and a certain mysterious indefinability. You may be drawn to careers in the arts, healing, spirituality, or any field where the connection between the visible and the invisible is the actual subject matter. Your public reputation has a quality that people find difficult to fully define. The challenge is difficulty maintaining the practical, concrete structures that a career requires alongside a genuinely non-material professional orientation. At your best your public work touches something in people that purely practical work never can.",
    11: "Neptune in your 11th house means your social world, your community connections, and your relationship to collective ideals carry a quality of spiritual depth and compassionate longing for genuine collective healing. You are drawn to communities organized around spiritual, creative, or humanitarian values. The challenge is a tendency to idealize communities and collective causes, projecting a perfection onto them that reality cannot sustain. At your best you bring a genuine quality of compassionate vision to any community you inhabit that inspires others toward something larger than individual self-interest.",
    12: "Neptune in your 12th house is the planet in its natural home — this amplifies everything about your relationship to the unconscious, the spiritual life, and the invisible dimensions of existence. Your inner life is extraordinarily rich and your connection to the spiritual dimensions of existence is direct and profound. Dreams, synchronicities, and mystical experiences are real and significant for you. The challenge is the boundary between inner and outer — between your imaginal world and practical reality — which can become dangerously permeable. At your best you have access to a depth of spiritual wisdom and compassionate understanding that is genuinely rare.",
  },

  Pluto: {
    1: "Pluto in your 1st house means transformation, power, and an intensity that is immediately felt by others are built into your very presence. You walk into rooms and people notice — not always comfortably. Your identity has been forged through significant transformation, and who you appear to be may be quite different from who you actually are beneath the surface. The challenge is a tendency to be either controlling or controlled, to attract power struggles, and to carry your own intensity as a burden. At your best you are one of the most genuinely transformative presences anyone will encounter — someone who changes the people who let you in.",
    2: "Pluto in your 2nd house means your relationship to money, material security, and self-worth has been shaped by experiences of radical loss, transformation, or the encounter with power and its relationship to resources. You may have experienced significant financial upheaval or carry a complex relationship to your own worth that has deep psychological roots. The challenge is an all-or-nothing relationship to material security and a tendency toward either hoarding or destroying what you have built. At your best you develop a relationship to your own worth that is genuinely indestructible — a self-valuation built from the inside out that no external circumstance can touch.",
    3: "Pluto in your 3rd house means your mind and your communication carry a quality of psychological penetration, intensity, and transformative power. You see beneath the surface of language — the real meaning beneath what is being said, the psychological pattern beneath the stated position. Your words have unusual impact. The challenge is a communication style that can feel invasive or overwhelming to people who are not ready for the level of truth you naturally deliver. At your best you are one of the most psychologically penetrating and genuinely transformative communicators in any environment.",
    4: "Pluto in your 4th house means your home, family, and deepest psychological roots have been shaped by experiences of significant intensity, transformation, or the encounter with power dynamics in their most fundamental form. Your family of origin likely carried significant psychological complexity — secrets, power struggles, or grief that shaped your inner world profoundly. The challenge is a difficulty accessing the safety and nourishment that home should provide. At your best you do the deep psychological work of transforming your family inheritance rather than simply repeating it — and in doing so, you change the pattern for everyone who comes after you.",
    5: "Pluto in your 5th house means your creative expression and romantic life carry an intensity and transformative power that sets them apart from ordinary creative and romantic experience. You do not create casually or love lightly — when you are in, you are completely in, which means the stakes are always high. Your creative work tends toward the psychologically deep, the dark, and the genuinely transformative. The challenge is a tendency to create and love in ways that consume rather than nourish. At your best your creative work is among the most psychologically powerful and genuinely transformative produced by anyone in your generation.",
    6: "Pluto in your 6th house means your relationship to work, health, and daily routine has been shaped by experiences of significant transformation, crisis, or the encounter with power dynamics in working environments. You cannot do surface-level work — you need to feel that what you are doing has real significance at a deep level. Your health may have been shaped by significant difficulty. The challenge is a working life characterized by power struggles and a difficulty sustaining environments that do not match your need for depth and transformation. At your best you bring a transformative intensity to your daily work that produces results of genuine and lasting significance.",
    7: "Pluto in your 7th house means your partnerships carry a quality of intense transformation, power dynamics, and the possibility of a depth of connection that most people never experience. Your most significant relationships change you fundamentally — you are not the same person after them. You may attract partners of significant psychological intensity or find that power and control are recurring themes in your closest connections. The challenge is a pattern of relationships that are transformative in the most difficult possible sense — that take you apart rather than building you up. At your best your partnerships are genuinely transformative for both people in the best possible way.",
    8: "Pluto in your 8th house is the planet in its natural home — this amplifies everything about your relationship to transformation, power, shared resources, and the deep mysteries of existence. You have an extraordinary relationship to the invisible dimensions of life. Your capacity for psychological penetration, for going beneath the surface of things, and for surviving and growing through experiences that would destroy other people is remarkable. The challenge is the sheer intensity of your own inner world and the difficulty of living at the depth that this placement demands. At your best you are one of the most genuinely transformative forces in any environment you inhabit.",
    9: "Pluto in your 9th house means your relationship to belief, philosophy, and meaning has been shaped by radical transformation, disillusionment, and the encounter with the dark dimensions of ideology and truth. Your beliefs have been through the fire — you have likely experienced significant crises of faith that stripped away everything that was not genuinely yours. The challenge is a philosophical all-or-nothing quality — a tendency to either hold your beliefs with an intensity that approaches fanaticism or to destroy them entirely. At your best you develop a philosophy of extraordinary depth and genuineness that has been tested by real experience and survived.",
    10: "Pluto in your 10th house means your public life and career carry a quality of significant power, transformation, and the possibility of both extraordinary impact and significant opposition. You are drawn to positions of real power and your professional work tends toward the transformative — toward changing things at a fundamental level. Your reputation may go through radical transformations over the course of your life. The challenge is a professional life characterized by power struggles and a tendency to attract opposition proportional to your ambition. At your best your public work transforms whatever field you operate in at a genuinely fundamental level.",
    11: "Pluto in your 11th house means your relationship to community, collective ideals, and your sense of belonging within groups carries a quality of intensity, transformation, and the encounter with collective power dynamics. Your communities tend to go through significant transformations and you are often the catalyst for that change. You may have experienced significant loss or betrayal within groups. The challenge is a pattern of either controlling communities or being controlled by them. At your best you are one of the most genuinely transformative forces for collective change in any community you inhabit — someone who changes the group at a fundamental level.",
    12: "Pluto in your 12th house means the most powerful, transformative, and psychologically intense dimensions of your experience operate largely in the unconscious — in the hidden, the repressed, and the territory that most people never choose to enter. Your shadow material is significant and demands genuine engagement rather than suppression. Dreams and unconscious patterns carry unusual power in your life. The challenge is a psychological intensity that operates below the level of awareness and shapes your behavior in ways you may not always recognize or understand. At your best you do the deep unconscious work that produces a genuine psychological power and spiritual wisdom of extraordinary depth.",
  },
  ...
  return (
    <div style={{marginBottom:28}}>
      ...
      <div style={{display:"flex",justifyContent:"center",position:"relative"}}>
        ...
        <svg viewBox="0 0 500 500" width="100%" style={{maxWidth:400,borderRadius:"50%",background:"radial-gradient(circle,#0a0a0a,#000000)",filter:"drop-shadow(0 0 22px rgba(245,200,66,0.18))"}}>
...
function BirthChartHeroWheel({ name, chartPlanets = {}, fullPlanets = [] }) {
  ...
  // ── Data-driven accents (this is the only API-derived layer in the hero) ──
  ...
  // A small, curated set of classical planets — not the full ten, to keep this wheel clean
      ...
      <div style={{background:"#000",borderRadius:28,overflow:"hidden",border:"1px solid rgba(245,200,66,0.35)",boxShadow:"0 0 90px rgba(245,200,66,0.18), inset 0 0 80px rgba(0,0,0,0.85)"}}>
        ...
        <div style={{padding:"36px 22px 28px",textAlign:"center",position:"relative"}}>
          ...
          <svg viewBox={`0 0 ${W} ${H}`} width="100%" style={{maxWidth:480,display:"block",margin:"0 auto"}}>
            ...
            {signOrder.map((sign, i) => {
              ...
              return (
                <g key={sign}>
                  ...
                  {/* Big Three badge — tiny glyph(s) for Sun/Moon/Rising landing in this sign */}
                  {hits && (
            ...
            {/* Subtle markers for the classical planets, placed within their own sign's arc */}
            {markerPlanets.map((p, i) => {
              const signIdx = signOrder.indexOf(p.sign);
              // spread same-sign planets slightly so they don't stack exactly
...
function BirthChartResults({ result, onReset, onUpgrade }) {
  ...
  const [openHouseState, setOpenHouseState] = useState(null);
  ...
  const PaidSection = () => (
    <div style={{animation:"up 0.5s ease"}}>
      ...
      {/* Verified badge */}
      <div style={{background:"rgba(168,224,96,0.08)",border:"1px solid rgba(168,224,96,0.3)",borderRadius:10,padding:"10px 16px",marginBottom:20,textAlign:"center"}}>
        <span style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:9,color:"#a8e060",letterSpacing:".12em"}}>✦ FULL READING UNLOCKED ✦</span>
      </div>

      {/* Technical Natal Chart — full geometry: houses, aspects, transits */}
      {houseCusps.length > 0 && fullPlanets.length > 0 && (
        <div style={{marginBottom:8}}>
          <div style={{textAlign:"center",marginBottom:4}}>
            <div style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:11,color:"#f5c842",letterSpacing:".14em"}}>✦ EXPLORE YOUR FULL CHART ✦</div>
            <div style={{fontFamily:"Georgia,serif",fontSize:10,color:"#6a6058",marginTop:2}}>The complete technical geometry — houses, aspects, and today's transits.</div>
          </div>
        ...
        <div style={{marginBottom:28}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6}}>
            {houseCusps.map((h, i) => {
              ...
              // houseDescriptions defined at module level

              const signKey = h.sign;
              const displayText = houseDescriptions[h.house]?.[signKey] || "Tap to read about this house placement.";
              return (
  ...
  return (
    <div style={{animation:"up 0.5s ease"}}>
      {/* Hero wheel — ornate, curated, data-driven Big Three + planet accents */}
      <div style={{textAlign:"center",marginBottom:14}}>
      ...
      <BirthChartHeroWheel name={name} chartPlanets={chartPlanets} fullPlanets={fullPlanets} />
          ...
          <div style={{display:"flex",justifyContent:"space-around"}}>
            {["Sun","Moon","Rising"].map(p => chartPlanets[p] ? (
              <div key={p} style={{textAlign:"center"}}>
                <div style={{fontSize:24,marginBottom:4}}>{emojis[chartPlanets[p]]}</div>
                <div style={{fontFamily:"'Cinzel',serif",fontWeight:900,fontSize:13,color:colors[chartPlanets[p]]||"#f5c842",marginBottom:2}}>{chartPlanets[p]}</div>
                <div style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:8,color:"#6a6058",letterSpacing:".1em"}}>{p.toUpperCase()}</div>
              </div>
            ) : (
              <div key={p} style={{textAlign:"center",opacity:0.3}}>
                <div style={{fontSize:24,marginBottom:4}}>{emojis[p]}</div>
                <div style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:8,color:"#4a4440"}}>{p.toUpperCase()}</div>
              </div>
            ))}
          </div>
        </div>
...
const ALL_SIGNS_C = ["Aries","Taurus","Gemini","Cancer","Leo","Virgo","Libra","Scorpio","Sagittarius","Capricorn","Aquarius","Pisces"];
        ...
        <div style={{flex:1, minWidth:0}}>
          ...
          <div style={{display:"flex", gap:4, marginTop:10, alignItems:"center", flexWrap:"wrap", borderTop:"1px solid rgba(255,200,50,0.08)", paddingTop:8}}>
            ...
            <div style={{position:"relative"}}>
              ...
              {showShare && (
                <div style={{position:"fixed",bottom:"auto",right:16,zIndex:9999,background:"#1a1520",border:"1px solid rgba(255,200,50,0.3)",borderRadius:10,padding:"6px",minWidth:170,boxShadow:"0 4px 20px rgba(0,0,0,0.8)",animation:"up .2s ease",marginTop:4}}>
...
export default function AstrologyApp() {
  ...
  return (
    <div style={{minHeight:"100dvh",width:"100%",background:"#0d0a14",fontFamily:"Georgia,serif",color:"#ffffff",position:"relative",overflow:"hidden",margin:0,padding:0,boxSizing:"border-box"}}>
