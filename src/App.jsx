...
"Cancer-Mercury": ["Mercury in Cancer means your mind is deeply intuitive and emotionally intelligent. You pick up on what is not being said in a conversation as fluently as what is.","Your memory for feeling is extraordinary. You do not just remember events – you remember exactly how they felt, who said what, and the atmosphere in the room. This makes you a natural storyteller.","You think best when you feel safe. In environments where you feel exposed or judged, your mind goes quiet. In environments of genuine trust, you become one of the most insightful people in the conversation."],
"Leo-Mercury": ["Mercury in Leo gives you a natural gift for communication that commands attention. When you speak – in a room, in writing, in any medium – people orient toward you instinctively.","You think in narratives, not bullet points. Your mind naturally organizes information into stories with stakes, characters, and momentum – which is why you are so persuasive without even trying.","Your ideas come with conviction. You do not float suggestions – you make pronouncements. This is enormously effective when you are right, which is often, and worth watching when you are not."],
"Virgo-Mercury": ["Mercury in Virgo is the planet in its home and exaltation – the most analytically precise placement in the zodiac. Your mind is a finely calibrated instrument.","You notice the error everyone else walked past. The misplaced word, the flawed assumption buried in paragraph three, the number that does not quite add up – these register for you automatically and immediately.","You express care through precision. When you edit someone's work, give directions, or explain something, the extraordinary detail you bring is an act of respect – you are taking it seriously enough to get it exactly right."],
"Libra-Mercury": ["Mercury in Libra gives you a mind that is naturally diplomatic, fair, and extraordinarily good at seeing every side of any situation with genuine clarity.","You think in relationships between ideas rather than isolated facts. The most interesting question for you is never what something is – it is how it connects to, balances against, and affects everything around it.","Your communication is elegant by instinct. You have a gift for saying difficult things in ways that preserve the relationship, which makes you invaluable in any situation where honesty and tact both matter."],
"Scorpio-Mercury": ["Mercury in Scorpio gives you a mind that goes beneath the surface automatically. Surface-level explanations feel insufficient to you – you need to understand the root, the motive, the thing underneath the thing.","You are a natural lie detector. You read subtext, body language, and what is conspicuously absent from a conversation with an accuracy that unsettles people who are not being fully honest.","Your silence is as powerful as your words. You know exactly when to withhold information, when to ask the question that changes everything, and when to simply let someone else reveal themselves."],
"Sagittarius-Mercury": ["Mercury in Sagittarius gives you a philosophical mind that is always reaching for the bigger picture. Individual facts interest you primarily as evidence for or against a larger theory about how things work.","You speak with a confidence and enthusiasm that is genuinely infectious. Your ideas arrive with energy – you are not reporting information, you are making a case, and people feel the difference.","Your honesty can arrive faster than your tact. You say the true thing before you have finished calculating whether this is the right moment – which means people always know where they stand with you."],
"Capricorn-Mercury": ["Mercury in Capricorn gives you a mind that is strategic, disciplined, and oriented toward what is actually useful. You do not think in abstractions unless they have a practical application.","Your communication is economical and precise. You do not use ten words when four will do, and the four you choose are always exactly right. People who listen carefully to you realize you never waste a sentence.","You think in long timelines. Where others are planning for next week, you are mapping the next three years – which means you often see outcomes that others genuinely cannot perceive from where they are standing."],
"Aquarius-Mercury": ["Mercury in Aquarius gives you a mind that operates outside the mainstream almost by default. Your best ideas arrive from a direction no one else was looking, which is both your gift and occasionally your isolation.","You think in systems, patterns, and structures rather than individual cases. One instance is interesting; what that instance reveals about the underlying pattern is what actually captures your attention.","Your intellectual independence is total. You form your own conclusions from your own research and you hold them until genuinely better evidence arrives – not until social pressure mounts."],
"Pisces-Mercury": ["Mercury in Pisces gives you a mind that thinks in images, feelings, and impressions rather than linear logic. Your intelligence is intuitive and associative – you arrive at correct conclusions through routes you cannot always explain.","You communicate with a poetic quality that is not affectation – it is simply how your mind works. The metaphor, the story, the feeling-tone of an idea is as real to you as its literal content.","Your imagination is your most powerful cognitive tool. You can feel your way into a situation, a character, or a problem with an empathy and fluidity that more analytical minds genuinely cannot access."],

// ── MARS ──
"Aries-Mars": ["Mars in Aries is the planet in its home sign – the most direct, energized, and instinctively courageous placement Mars can occupy. You act first and assess later, and your instincts are usually correct.","Your anger is clean. It arrives fast, burns hot, and is gone before others have even processed that there was a conflict. You do not nurse grievances – you express the feeling and move on.","You are most alive when you are competing, initiating, or going first into something new. Waiting, deliberating, and following someone else's lead are genuinely uncomfortable for you in a physical, not just emotional, way."],
"Taurus-Mars": ["Mars in Taurus moves slowly and builds unstoppably. You do not rush into action – but once you have decided to move, nothing redirects you. Your persistence is one of the most powerful forces in the zodiac.","Your drive is sensory and material. You work for things you can touch, own, inhabit, and enjoy. Abstract ambitions do not motivate you the way physical security and genuine comfort do.","You have an extraordinary capacity for sustained effort. Where others sprint and burn out, you set a pace you can maintain for years – and you are almost always still standing at the finish line."],
"Gemini-Mars": ["Mars in Gemini means your energy is mental first. You are most activated by intellectual challenge, debate, and the fast exchange of ideas. Boredom is a genuine physical drain for you.","You can pursue multiple goals simultaneously without losing track of any of them. Your mind manages parallel tracks naturally – which gives you an agility in action that more focused signs genuinely envy.","Your arguments are fast, precise, and occasionally devastating. When you are in conflict, you reach for words rather than force – and your words are usually the sharpest weapon in the room."],
"Cancer-Mars": ["Mars in Cancer means your drive is deeply protective. You are not motivated by glory or competition – you are motivated by the safety and wellbeing of the people and places you love. That motivation is ferocious.","Your energy moves in tides rather than straight lines. There are periods of intense, focused effort followed by genuine withdrawal. This is not inconsistency – it is your natural rhythm, and it works if you honor it.","When someone threatens what you care about, a fierceness emerges that surprises people who only know your softer side. Cancer is the sign of the mother protecting her young – and that energy is not gentle."],
"Leo-Mars": ["Mars in Leo drives you toward visibility, recognition, and the expression of your full creative power. You do not just want to succeed – you want to succeed in a way that people remember.","Your energy is theatrical and generous. You bring drama, warmth, and genuine commitment to everything you pursue – which makes you one of the most compelling people to work with, follow, or compete against.","Your pride is your fuel. The suggestion that you cannot do something, that you are not good enough, or that someone else might outperform you activates a competitive fire that is extremely difficult to extinguish."],
"Virgo-Mars": ["Mars in Virgo channels your drive into precision, improvement, and the relentless refinement of whatever you are working on. You are not satisfied with good enough – ever.","Your work ethic is extraordinary and occasionally punishing. You hold yourself to standards that most people would find exhausting, and the inner critic that drives you is louder than any external voice.","You are most effective when you have a clear problem to solve. Vague goals frustrate you; specific targets with measurable progress activate your best and most focused energy."],
"Libra-Mars": ["Mars in Libra is the planet in its most challenged placement – you are built for harmony in a planet that runs on conflict. Your drive is toward justice, fairness, and the resolution of imbalance.","You do not act unilaterally if you can help it. You consult, consider, and weigh before moving – which makes you slower to start than some signs but far more strategically effective once you do.","When you finally decide to fight for something, you fight with extraordinary skill and composure. You have spent so long weighing both sides that you know exactly where the weak points are."],
"Scorpio-Mars": ["Mars in Scorpio is one of the most intensely driven placements in the zodiac. Your energy is focused, strategic, and almost completely invisible until the moment it is needed – and then it is overwhelming.","You do not pursue surface-level goals. Everything you go after has a deeper significance – power, transformation, truth, or the resolution of something that has been unfinished for too long.","Your capacity for sustained focus on a single target is unmatched. You do not get distracted, you do not get discouraged, and you do not give up. The combination of those three things makes you formidable."],
"Sagittarius-Mars": ["Mars in Sagittarius drives you toward freedom, expansion, and the feeling that you are moving toward something larger than where you currently are. Confinement – physical, intellectual, or social – is intolerable.","Your energy is enthusiastic and contagious. When you are genuinely excited about a direction, you bring people with you through the sheer force of your belief that it is going to work.","You pursue goals in bursts of intense, inspired effort rather than steady daily discipline. Your best work happens when you are lit up – and it is extraordinary when you are."],
"Capricorn-Mars": ["Mars in Capricorn is exalted – the planet of drive in the sign of mastery. Your ambition is patient, strategic, and oriented toward building something that lasts. You are playing a longer game than almost everyone around you.","You do not waste energy on fights you cannot win or goals that do not serve your larger structure. Every action is evaluated against the long-term architecture you are building – which makes you exceptionally efficient.","Your discipline is your superpower. You can delay gratification indefinitely in service of a goal that matters to you – and the results of that capacity compound over years into outcomes that look like overnight success to everyone watching."],
"Aquarius-Mars": ["Mars in Aquarius drives you toward collective impact, innovation, and the disruption of systems that are no longer working. Your ambition is not personal – it is structural.","You are most energized when working toward something that benefits more than just yourself. Individual achievement feels hollow compared to the satisfaction of contributing to a shift that changes things for a group.","Your approach to conflict is detached and strategic rather than emotional. You do not get angry in a hot way – you get precise, which is often more effective and occasionally more unnerving."],
"Pisces-Mars": ["Mars in Pisces drives you through feeling rather than strategy. You move toward what you love and away from what deadens you – and your intuition about which is which is more reliable than any rational analysis.","Your energy is diffuse and creative rather than focused and direct. You work best when you have freedom to move between modes, follow inspiration, and trust the process rather than execute a rigid plan.","When you are connected to a purpose that genuinely moves you – creative, spiritual, or service-oriented – you access a devotion and endurance that more practically-driven signs cannot match."],
...
"Virgo-Pluto": ["Pluto in Virgo (1956–1972) transformed an entire generation's relationship to work, health, and the systems that sustain life. Your cohort arrived to dismantle and rebuild the infrastructure of daily existence.","You carry a deep compulsion toward improvement, analysis, and the correction of what is broken – in bodies, in systems, in processes. Your generation produced the thinkers who would rebuild the world's operating systems from the inside."],
"Libra-Pluto": ["Pluto in Libra (1971–1984) transformed an entire generation's relationship to partnership, justice, and the balance of power in relationships of every kind. Your cohort arrived to renegotiate every contract between individuals.","You carry a deep awareness of power dynamics in relationships that previous generations either did not see or chose not to name. Your generation brought that awareness into the open – sometimes destructively, often transformatively."],
"Scorpio-Pluto": ["Pluto in Scorpio (1983–1995) is the planet in its home sign – producing the most intensely transformative generational placement possible. Your cohort arrived carrying a collective assignment to face what previous generations had buried.","You were born into a world where the shadow was erupting into visibility – AIDS, addiction, environmental collapse, the end of the Cold War. Your generation's relationship to mortality, power, and truth is unlike any that came before it."],
"Sagittarius-Pluto": ["Pluto in Sagittarius (1995–2008) transformed an entire generation's relationship to belief, globalization, and the clash of worldviews. Your cohort arrived at the exact moment when every absolute was being questioned simultaneously.","You carry a deep awareness that belief systems are constructed, that truth is contested, and that the map is not the territory. Your generation's philosophical fluency – and its accompanying anxiety – is the direct result of Pluto's passage through the sign of meaning."],
"Capricorn-Pluto": ["Pluto in Capricorn (2008–2024) is transforming an entire generation's relationship to authority, institutions, and the structures of power. Your cohort is arriving into a world where every establishment is in the process of being dismantled and rebuilt.","You were born knowing at a cellular level that the old structures do not hold – not because you read it somewhere, but because you arrived at the exact moment it became undeniable. What you build in their place is your generational assignment."],
...
// Build celebrity lookup by sign (supports multiple per sign for rotation)
const celebBySign = {};
...
// ── CELEBRITY CONNECTION (with rotation) ──
...
function CelebrityConnection() {
  ...
  const handleNext = () => {
    const pool = celebBySign[selectedSign] || [];
    setCelebIndex(i => (i + 1) % pool.length);
  };

  const handlePrev = () => {
    const pool = celebBySign[selectedSign] || [];
    setCelebIndex(i => (i - 1 + pool.length) % pool.length);
  };
        ...
        <div style={{animation:"up .4s ease"}}>
          ...
          {pool.length > 1 && (
            <div style={{display:"flex",justifyContent:"center",alignItems:"center",gap:16,marginTop:20}}>
              <button onClick={handlePrev} style={{background:"none",border:"1px solid rgba(255,200,50,0.3)",color:"#f5c842",padding:"8px 18px",borderRadius:"100px",fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:10,letterSpacing:".1em",cursor:"pointer"}}>← PREV</button>
              ...
              <button onClick={handleNext} style={{background:"none",border:"1px solid rgba(255,200,50,0.3)",color:"#f5c842",padding:"8px 18px",borderRadius:"100px",fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:10,letterSpacing:".1em",cursor:"pointer"}}>NEXT →</button>
            </div>
          )}
        </div>
      )}
...
function GuessYourSign() {
  ...
  if (step === "start") return (
    <div style={{animation:"up .5s ease",textAlign:"center",paddingTop:20}}>
      ...
      <div style={{display:"inline-block",background:"rgba(255,200,50,0.07)",border:"1px solid rgba(255,200,50,0.25)",borderRadius:12,padding:"10px 22px",marginBottom:28}}>
        <span style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:10,color:"#f5c842",letterSpacing:".1em"}}>✦ 4 FREE QUESTIONS TO START ✦</span>
      </div>
      <br/>
  ...
  if (step === "paywall") return (
    <div style={{animation:"up .5s ease",textAlign:"center"}}>
      <div style={{background:"linear-gradient(135deg,rgba(232,168,0,0.1),rgba(0,0,0,0.3))",border:"1px solid rgba(255,200,50,0.35)",borderRadius:20,padding:"36px 28px",marginBottom:20,position:"relative",overflow:"hidden"}}>
        ...
        <div style={{fontFamily:"'Cinzel',serif",fontWeight:900,fontSize:20,color:"#f5c842",marginBottom:10}}>You've used your 4 free questions!</div>
        <p style={{fontFamily:"Georgia,serif",color:"#d8c890",fontSize:15,lineHeight:1.75,marginBottom:20}}>
          Unlock unlimited questions –<br/>sign up for a <strong style={{color:"#f5c842"}}>7-day free trial</strong>.<br/>
          A <strong style={{color:"#a8e060"}}>small card authorization</strong> verifies your payment method today – it is not a charge and is released automatically.<br/>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:8,alignItems:"center",marginBottom:24}}>
          {["✦ Unlimited questions with your subscription","✦ Unlimited replays","✦ Cancel instantly via Stripe – no emailing required"].map((item,i)=>(
      ...
      <p style={{fontFamily:"Georgia,serif",fontSize:11,color:"#3a3228",lineHeight:1.6,padding:"0 8px"}}>
        Your card will not be charged today. The authorization hold confirms your payment method and is released within a few business days. After your 7-day free trial, your subscription of $4.99/month begins automatically unless you cancel before the trial ends.
      </p>
    </div>
  );
  ...
  if (step === "playing" && currentQ) {
    ...
    return (
      <div style={{animation:"up .45s ease"}}>
        ...
        {score.total>0&&<p style={{fontFamily:"'Cinzel',serif",fontWeight:700,fontSize:10,color:"#f5c842",marginTop:16,textAlign:"center"}}>Score: {score.correct}/{score.total}</p>}
      </div>
    );
  }
...
function TermsContent(){return(<>
  ...
  <DocSection title="1. About Arewewoke"><DocP>Arewewoke is an astrology-based entertainment application operated by Ayssia Mason. The app provides astrological content including cosmic fun facts, daily horoscopes, celebrity connections, and the Guess Your Sign game for entertainment purposes only.</DocP></DocSection>
  <DocSection title="2. Entertainment Disclaimer"><DocP>All content on Arewewoke is intended solely for entertainment and personal reflection. Nothing on this platform constitutes professional advice of any kind, including but not limited to medical, psychological, financial, or legal advice.</DocP></DocSection>
  <DocSection title="3. Eligibility"><DocP>You must be at least 18 years of age to subscribe to paid features of Arewewoke. By subscribing, you represent and warrant that you meet this age requirement.</DocP></DocSection>
  <DocSection title="4. Free Trial & Billing"><DocP>Arewewoke offers a 7-day free trial for the Guess Your Sign full feature. A small card authorization hold is placed on your payment method at sign-up to verify it is valid. This hold is not a charge and is released automatically within a few business days. After the 7-day trial period, your subscription automatically renews at $4.99 per month unless you cancel before the trial ends. You will receive a reminder before your trial converts to a paid subscription.</DocP></DocSection>
  <DocSection title="5. Cancellation"><DocP>You may cancel your subscription at any time via the Stripe customer portal — no emailing required. Cancellation takes effect at the end of the current billing period. See our Cancellation Policy for full details.</DocP></DocSection>
  <DocSection title="6. Intellectual Property"><DocP>All content, design, and features of Arewewoke are the property of Ayssia Mason unless otherwise credited. You may not reproduce, distribute, or create derivative works from any content on this platform without express written permission.</DocP></DocSection>
  <DocSection title="7. Limitation of Liability"><DocP>Arewewoke and Ayssia Mason shall not be liable for any indirect, incidental, or consequential damages arising from your use of the app or reliance on any astrological content provided. The app is provided on an as-is basis.</DocP></DocSection>
  <DocSection title="8. Changes to Terms"><DocP>We reserve the right to update these Terms of Service at any time. Continued use of the app after changes constitutes acceptance of the revised terms.</DocP></DocSection>
  <DocSection title="9. Contact"><DocP>arewewoke@gmail.com</DocP></DocSection>
</>);}

function PrivacyContent(){return(<>
  <DocP>Your privacy matters to Arewewoke. This policy explains what information we collect, how we use it, and your rights.</DocP>
  <DocSection title="1. Information We Collect"><DocBullet items={["Email address and name when you subscribe or contact us","Payment information, processed securely by Stripe — we never store full card details on our servers","Usage data and device information used to improve app performance and experience","Subscription status, stored securely to manage your access to paid features"]}/></DocSection>
  <DocSection title="2. How We Use Your Information"><DocBullet items={["To process and manage your subscription","To send receipts, billing communications, and subscription reminders","To improve app features, content, and user experience","To respond to support requests or inquiries"]}/><DocP>We do not sell, rent, share, or trade your personal information to third parties for marketing purposes. Stripe processes all payment data under their own privacy policy and security standards.</DocP></DocSection>
  <DocSection title="3. Data Retention"><DocP>We retain your account information for as long as your subscription is active or as needed to fulfill legal obligations. You may request deletion of your data at any time by emailing arewewoke@gmail.com.</DocP></DocSection>
  <DocSection title="4. Cookies & Tracking"><DocP>Arewewoke does not use advertising cookies or third-party tracking. Basic session data may be stored to maintain your experience within the app.</DocP></DocSection>
  <DocSection title="5. Your Rights"><DocP>You have the right to access, correct, or delete the personal data we hold about you. To exercise these rights, contact us at arewewoke@gmail.com.</DocP></DocSection>
  <DocSection title="6. Contact"><DocP>arewewoke@gmail.com</DocP></DocSection>
</>);}

function CancellationContent(){return(<>
  <DocP>This policy applies to all paid subscriptions to Arewewoke. We want the process to be simple, transparent, and fully in your control.</DocP>
  <DocSection title="Free Trial Period"><DocP>Your 7-day free trial begins the moment your payment method is verified via the authorization hold. You will not be charged during the trial. If you do not cancel before the trial ends, your $4.99/month subscription begins automatically on day 8.</DocP></DocSection>
  <DocSection title="How to Cancel"><DocBullet items={["Via the Stripe customer portal — the fastest method, available 24/7, no emailing required. Your cancellation is confirmed immediately and Stripe sends a confirmation email automatically.","By emailing arewewoke@gmail.com with the subject line: Cancel My Subscription. Allow up to 2 business days for processing."]}/><DocP>Cancellation takes effect at the end of your current billing period. You retain access to paid features until that date.</DocP></DocSection>
  <DocSection title="Refund Policy"><DocP>All subscription fees are non-refundable once charged. We do not offer refunds for partial months or for subscriptions that were not cancelled before renewal. The authorization hold placed at sign-up is not a charge and is not subject to refund policy — it is released automatically.</DocP></DocSection>
  <DocSection title="Trial Cancellation"><DocP>If you cancel during the 7-day free trial, you will not be charged. Your access to paid features ends when the trial period closes.</DocP></DocSection>
  <DocSection title="Contact"><DocP>arewewoke@gmail.com</DocP></DocSection>
</>);}

function DisclaimerContent(){return(<>
  <DocP>All astrological content on Arewewoke is provided strictly for entertainment and personal reflection. Astrology is a belief system and symbolic framework, not an empirical science. Arewewoke makes no claim that any astrological interpretation is scientifically accurate, predictive, or deterministic.</DocP>
  <DocSection title="Not Professional Advice"><DocP>Nothing on Arewewoke constitutes medical, psychological, financial, legal, or any other form of professional advice. If you are experiencing mental health concerns, financial difficulty, legal issues, or health problems, please consult a qualified professional. Astrological insights are not a substitute for professional guidance.</DocP></DocSection>
  <DocSection title="Individual Results"><DocP>Astrological descriptions are generalizations based on symbolic traditions. They may not reflect any individual's specific circumstances, personality, or life outcomes. User discretion is advised.</DocP></DocSection>
  <DocSection title="Celebrity Information"><DocP>Birth data and astrological placements for public figures referenced in the app are sourced from publicly available records and astrological databases. Arewewoke does not claim insider knowledge of any individual's personal life or character.</DocP></DocSection>
  <DocSection title="Contact"><DocP>arewewoke@gmail.com</DocP></DocSection>
</>);}

function CreditsContent(){return(<>
  <DocP>Arewewoke is created and operated by Ayssia Mason. The astrological interpretations and content in this app are original creative work by Ayssia Mason, informed by the following foundational astrological authors and traditions. Ayssia Mason does not claim to be the original author of the astrological frameworks referenced.</DocP>
  <DocSection title="Astrological Authors & Works Referenced"><DocBullet items={["Steven Forrest — The Inner Sky, The Book of the Moon, and the evolutionary astrology tradition","Liz Greene — Saturn: A New Look at an Old Devil, The Astrology of Fate, and psychological astrology","Robert Hand — Planets in Transit, Horoscope Symbols","Howard Sasportas — The Twelve Houses","Donna Cunningham — humanistic interpretation of Moon and Venus placements","Isabel Hickey — Astrology: A Cosmic Science","Dane Rudhyar — An Astrological Mandala, humanistic and transpersonal astrology"]}/></DocSection>
  <DocSection title="Technical"><DocP>Arewewoke is built with React and hosted on Vercel. Payment processing is handled by Stripe. Fonts by Google Fonts (Cinzel).</DocP></DocSection>
  <DocSection title="Contact"><DocP>arewewoke@gmail.com</DocP></DocSection>
</>);}
