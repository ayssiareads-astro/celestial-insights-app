...
function CelebrityAvatar({ celeb }) {
 ...
 {[["__",celeb.sun],["_",celeb.moon],["__",celeb.rising]].map(([icon,val])=>(
 val && val !== "Unknown" ? (
...
function GuessYourSign() {
 ...
 <button className="rb" style={{"--a":accent}} onClick={startGame}>_ START GUESSING</button>
 ...
 <div style={{fontSize:40,marginBottom:12}}>{emojis[currentSign]||"_"}</div>
