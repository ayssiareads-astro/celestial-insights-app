      ...
      <div style={{background:"rgba(168,224,96,0.07)",border:"1px solid rgba(168,224,96,0.3)",borderRadius:20,padding:"32px 24px",marginBottom:16}}>
        ...
        {level === 1 && (
          <div style={{
            ...
            padding:"18px 16px",
            maxWidth:420,
            background:"linear-gradient(135deg,rgba(245,200,66,0.10),rgba(168,224,96,0.06))",
            border:"1px solid rgba(245,200,66,0.35)",
            borderRadius:16,
            boxShadow:"0 0 28px rgba(245,200,66,0.10)"
          }}>
            <div style={{fontFamily:"'Cinzel',serif",fontWeight:900,fontSize:12,color:"#f5c842",letterSpacing:".12em",marginBottom:8}}>✦ CHALLENGE A FRIEND ✦</div>
            <p style={{fontFamily:"Georgia,serif",fontSize:14,color:"#d8c890",lineHeight:1.65,margin:"0 0 14px"}}>
              You cleared Level 1. Share the quiz and see who really knows the zodiac better.
            </p>
            <button
  ...
  return (
    <div style={{marginBottom:28}}>
      ...
      <div style={{display:"flex",justifyContent:"center",position:"relative"}}>
        ...
        <svg viewBox="0 0 500 500" width="100%" style={{maxWidth:520,borderRadius:"50%",background:"radial-gradient(circle,#0a0a0a,#000000)",filter:"drop-shadow(0 0 30px rgba(245,200,66,0.22))"}}>
